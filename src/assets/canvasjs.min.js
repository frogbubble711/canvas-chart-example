...
(function () {
  ...
  function Va(k, m, v) {
    "millisecond" === v
      ? k.setMilliseconds(k.getMilliseconds() + 1 * m)
      : "second" === v
      ? k.setSeconds(k.getSeconds() + 1 * m)
      : "minute" === v
      ? k.setMinutes(k.getMinutes() + 1 * m)
      : "hour" === v
      ? k.setHours(k.getHours() + 1 * m)
      : "day" === v
      ? k.setDate(k.getDate() + 1 * m)
      : "week" === v
      ? k.setDate(k.getDate() + 7 * m)
      : "month" === v
      ? k.setMonth(k.getMonth() + 1 * m)
      : "year" === v && k.setFullYear(k.getFullYear() + 1 * m);
    return k;
  }
  function aa(k, m) {
    var v = !1;
  ...
  function eb(k) {
    if (I.fSDec)
      k[Z("`eeDwdouMhrudods")](Z("e`u`@ohl`uhnoHuds`uhnoDoe"), function () {
        I._fTWm && I._fTWm(k);
      });
  }
  function Wa(k, m, v) {
  ...
  function hb(k) {
    if (!ib) {
      ...
      "undefined" === typeof qa.Chart.creditHref
        ? ((k.creditHref = Z("iuuqr;..b`ow`rkr/bnl.")),
          (k.creditText = Z("B`ow`rKR/bnl")))
        : ((m = k.updateOption("creditText")),
  ...
  function va(k, m, v) {
    m.getAttribute("state") ||
      ((m.style.backgroundColor = k.toolbar.backgroundColor),
    ...
    m.getAttribute("state") !== v &&
      ...
      m.setAttribute("title", k._cultureInfo[v + "Text"]),
      (m.innerHTML =
  ...
  function Ka() {
    for (var k = null, m = 0; m < arguments.length; m++)
      (k = arguments[m]), k.style && (k.style.display = "inline");
  }
  function ua() {
    for (var k = null, m = 0; m < arguments.length; m++)
      (k = arguments[m]) && k.style && (k.style.display = "none");
  }
  function Ra(k, m, v, r, s) {
    if (null === k || "undefined" === typeof k)
      return "undefined" === typeof v ? m : v;
    k =
      parseFloat(k.toString()) * (0 <= k.toString().indexOf("%") ? m / 100 : 1);
    "undefined" !== typeof r &&
      ((k = Math.min(r, k)), "undefined" !== typeof s && (k = Math.max(s, k)));
  ...
  function X(k, m, v, s, w) {
    ...
    k = {};
    this.theme && r(this.parent) && r(m) && r(s)
      ? (k = r(this.predefinedThemes[this.theme])
      ...
      : this.parent &&
        ...
        (null === s
          ? (k = this.parent.themeOptions[m])
          : 0 < this.parent.themeOptions[m].length &&
            ((s = Math.min(this.parent.themeOptions[m].length - 1, s)),
            (k = this.parent.themeOptions[m][s])));
    this.themeOptions = k;
  ...
  function ya(k, m) {
    ya.base.constructor.call(this, "Title", "title", m, null, k);
    this.chart = k;
    this.canvas = k.canvas;
    this.ctx = this.chart.ctx;
    ...
    if (r(this.options.margin) && k.options.subtitles)
      for (var v = k.options.subtitles, s = 0; s < v.length; s++)
        if (
          ((r(v[s].horizontalAlign) && "center" === this.horizontalAlign) ||
            v[s].horizontalAlign === this.horizontalAlign) &&
          ((r(v[s].verticalAlign) && "top" === this.verticalAlign) ||
            v[s].verticalAlign === this.verticalAlign) &&
          !v[s].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  (function () {
    ...
    I._fTWm = function (k) {
      if ("undefined" === typeof I.pro.sCH && !bb)
        try {
  ...
  var fb = (function () {
        ...
        return (N = Q.replace(k, function (l) {
          switch (l) {
            ...
            case "K":
              return I
                ? "UTC"
                : (String(E).match(w) || [""]).pop().replace(D, "");
            case "z":
        ...
        if (((m = E[L]), "." === m && 0 > Q)) Q = L;
          ...
          if ("%" === m) D *= 100;
            ...
            ("E" !== m[0] && "e" !== m[0]) ||
              ...
              (T = !0);
          0 > Q
            ? (N.push(m), "#" === m || "0" === m ? S++ : "," === m && W++)
            : (G.push(m), ("#" !== m && "0" !== m) || I++);
        }
      T &&
        ((m = Math.floor(k)),
        (E = -Math.floor(Math.log(k) / Math.LN10 + 1)),
        (X = 0 === k ? 0 : 0 === m ? -(S + E) : String(m).length - S),
        (D /= Math.pow(10, X)));
      0 > Q && (Q = L);
      D = (k * D).toFixed(I);
      m = D.split(".");
        ...
        if (((m = N.pop()), "#" === m || "0" === m))
          if ((Q++, Q === S)) {
            ...
            for (; 0 < Y.length; )
              (v = Y.pop() + v),
                T++,
                0 === T % E && L === W && 0 < Y.length && (v = w + v);
          } else
            0 < D.length
              ? ((v = D.pop() + v), I++, T++)
              : "0" === m && ((v = "0" + v), I++, T++),
              0 === T % E && L === W && 0 < D.length && (v = w + v);
        else
          ("E" !== m[0] && "e" !== m[0]) ||
          "0" !== m[m.length - 1] ||
          !/[eE][+-]*[0]+/.test(m)
            ? "," === m
              ? (L++, (E = T), (T = 0), 0 < D.length && (v = w + v))
              : (v =
                  1 < m.length &&
                  (('"' === m[0] && '"' === m[m.length - 1]) ||
                    ("'" === m[0] && "'" === m[m.length - 1]))
    ...
    Na = function (k) {
      ...
      k.offsetX || 0 === k.offsetX
        ? ((m = k.offsetX), (v = k.offsetY))
        : k.layerX || 0 == k.layerX
        ? ((m = k.layerX), (v = k.layerY))
        : ((m = k.pageX - k.target.offsetLeft),
    ...
    da = function (k, m, v, r, s, w, D, E, Q, N, T, S, G) {
      ...
      0 < D &&
        ...
        (k.strokeStyle = E),
        k.moveTo(m, v),
        k.rect(m - G, v - G, r - m + 2 * G, s - v + 2 * G),
        k.stroke());
      k.restore();
      !0 === Q &&
        (k.save(),
        ...
        k.lineTo(r, v),
        k.closePath(),
        (D = k.createLinearGradient((r + m) / 2, v + I, (r + m) / 2, v)),
        D.addColorStop(0, w),
      ...
      !0 === N &&
        ...
        k.lineTo(r, s),
        k.closePath(),
        (D = k.createLinearGradient((r + m) / 2, s - I, (r + m) / 2, s)),
        D.addColorStop(0, w),
        D.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (k.fillStyle = D),
        k.fill(),
      ...
      !0 === T &&
        ...
        k.lineTo(m, s),
        k.closePath(),
        (D = k.createLinearGradient(m + I, (s + v) / 2, m, (s + v) / 2)),
        D.addColorStop(0, w),
      ...
      !0 === S &&
        ...
        k.lineTo(r - I, s - I),
        k.lineTo(r, s),
        (D = k.createLinearGradient(r - I, (s + v) / 2, r, (s + v) / 2)),
        D.addColorStop(0, w),
        D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (k.fillStyle = D),
        D.addColorStop(0, w),
    ...
    bb =
      window &&
      window[Z("mnb`uhno")] &&
      window[Z("mnb`uhno")].href &&
      window[Z("mnb`uhno")].href.indexOf &&
      (-1 !== window[Z("mnb`uhno")].href.indexOf(Z("b`ow`rkr/bnl")) ||
        -1 !== window[Z("mnb`uhno")].href.indexOf(Z("gdonqhy/bnl")) ||
        -1 !== window[Z("mnb`uhno")].href.indexOf(Z("gheemd"))),
  ...
  X.prototype.setOptions = function (k, m) {
    if (qa[this._defaultsKey]) {
      ...
      for (s in r)
        "publicProperties" !== s &&
          r.hasOwnProperty(s) &&
          (this[s] = k && s in k ? k[s] : m && s in m ? m[s] : r[s]);
  ...
  X.prototype.get = function (k) {
    ...
    if (
      m.hasOwnProperty(k) ||
      (m.publicProperties && m.publicProperties.hasOwnProperty(k))
    )
      return this[k];
    window.console &&
      window.console.log(
  ...
  X.prototype.set = function (k, m, r) {
    ...
    if ("options" === k) this.createUserOptions(m);
      ...
      s.hasOwnProperty(k) ||
      (s.publicProperties &&
        s.publicProperties.hasOwnProperty(k) &&
        "readWrite" === s.publicProperties[k])
    )
      ...
      if (
        ...
        (this.options = "undefined" === typeof k ? {} : k),
          ...
          this.optionsName
            ...
            ? ((r = m.charAt(0).toLowerCase()),
              1 < m.length && (r = r.concat(m.slice(1))),
              (m = r))
            : (m = void 0),
          (k[m] = this.options);
  };
  ...
  X.prototype.updateOption = function (k) {
    ...
    var m = qa[this._defaultsKey],
      ...
      I = this._index;
    this.theme && r(this.parent) && r(E) && r(I)
      ? (s = r(this.predefinedThemes[this.theme])
          ? this.predefinedThemes.light1
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        ...
        (null === I
          ? (s = this.parent.themeOptions[E])
          : 0 < this.parent.themeOptions[E].length &&
            ((s = Math.min(this.parent.themeOptions[E].length - 1, I)),
            (s = this.parent.themeOptions[E][s])));
    this.themeOptions = s;
    k in m &&
      (w = k in this.options ? this.options[k] : s && k in s ? s[k] : m[k]);
  ...
  X.prototype.addEventListener = function (k, m, r) {
    k &&
      ...
      this._eventListeners[k].push({ context: r || this, eventHandler: m }));
  };
  ...
  X.prototype.dispatchEvent = function (k, m, r) {
    if (k && this._eventListeners[k]) {
      m = m || {};
      for (var s = this._eventListeners[k], w = 0; w < s.length; w++)
        s[w].eventHandler.call(s[w].context, m);
    }
  ...
  Da.prototype.registerSpace = function (k, m) {
    "top" === k
      ...
      : "right" === k && (this._rightOccupied += m.width);
  };
    ...
    if (0 !== this.fontSize) {
      ...
      for (r = 0; r < this._wrappedText.lines.length; r++) {
        ...
        if ("right" === this.horizontalAlign || "right" === this.textAlign)
          s = this.width - E.width - this.rightPadding;
  ...
  la.prototype._getLineWithWidth = function (k, m, r) {
    ...
    r > m &&
      1 < D.length &&
      ((D = D.substr(0, D.length - 1)), (r = this.ctx.measureText(D).width));
    m = !0;
  ...
  ya.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((w = m.y2 - 2 - N.height), (G = "bottom")),
          "left" === this.horizontalAlign
            ? (s = m.x1 + 2)
            : "center" === this.horizontalAlign
            ? (s = m.x1 + m.width / 2 - N.width / 2)
            : "right" === this.horizontalAlign && (s = m.x2 - 2 - N.width - D),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((s = m.x1 + 2),
              (w = m.y2 - 2 - (this.maxWidth / 2 - N.width / 2)),
              (E = -90),
              (G = "left"),
              (this.width = N.height),
              (this.height = N.width))
            ...
            ? ((s = m.x2 - 2),
              (w = m.y1 + 2 + (this.maxWidth / 2 - N.width / 2)),
              (E = 90),
              (G = "right"),
              (this.width = N.height),
              (this.height = N.width))
            : "center" === this.horizontalAlign &&
              ((w = k.y1 + (k.height / 2 - N.height / 2)),
              (s = k.x1 + (k.width / 2 - N.width / 2)),
              (G = "center"),
              (this.width = N.width),
              (this.height = N.height)),
          (Q = "center"));
      ...
      k.layoutManager.registerSpace(G, {
        width:
          this.width + ("left" === G || "right" === G ? this.margin + 2 : 0),
        height:
          this.height + ("top" === G || "bottom" === G ? this.margin + 2 : 0),
      });
  ...
  w = Oa.Chart = (function () {
      ...
      (this.container =
        ...
        ? ((this.container.innerHTML = ""),
          ...
          this.canvas.getContext &&
            ...
            (this._eventManager = new ea(this)),
            (this.windowResizeHandler = W(
              window,
              "resize",
              function () {
      ...
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b =
            (Math.abs(
              (a[l].x - a[f].x) /
                (0 === a[l].x - a[u].x ? 0.01 : a[l].x - a[u].x)
            ) *
              (d - 1)) /
              2 +
            1;
          ...
          b = (a[l].y - a[f].y) / b;
          c[c.length] =
            (a[u].x > a[f].x && 0 < z) || (a[u].x < a[f].x && 0 > z)
              ? { x: a[u].x + z / 3, y: a[u].y + b / 3 }
              : { x: a[u].x, y: a[u].y + b / 9 };
          u = e;
          f = 0 === u ? 0 : u - 1;
          l = u === a.length - 1 ? u : u + 1;
    ...
    function w(a, d, c, b, e, f, l, u, z, h) {
      var p = 0;
      h ? ((l.color = f), (u.color = f)) : (h = 1);
      p = z ? Math.abs(e - c) : Math.abs(b - d);
      p =
        0 < l.trimLength
          ? Math.abs((p * l.trimLength) / 100)
          : Math.abs(p - l.length);
      ...
      a.beginPath();
      z && 0 < u.thickness
        ? (a.moveTo(b - l.thickness / 2, Math.round((c + e) / 2) - n),
          a.lineTo(d + l.thickness / 2, Math.round((c + e) / 2) - n))
        : 0 < u.thickness &&
          (a.moveTo(Math.round((d + b) / 2) - n, c + l.thickness / 2),
          a.lineTo(Math.round((d + b) / 2) - n, e - l.thickness / 2));
      a.stroke();
    ...
    function G(a, d, c, b) {
      G.base.constructor.call(this, "DataSeries", "data", d, c, a);
      this.chart = a;
      this.canvas = a.canvas;
          ...
          W(
            ...
            function () {
              d ||
                ...
                0 >= navigator.userAgent.search("MSIE") &&
                  pa(a._resetButton.childNodes[0], {
                    WebkitFilter: "invert(100%)",
                    filter: "invert(100%)",
                  }));
            },
    ...
    m.prototype._initialize = function () {
      ...
      this._updateOptions();
      this.animatedRender =
        s && this.animationEnabled && 0 === this.renderCount;
      this._updateSize();
      this.clearCanvas();
      this.ctx.beginPath();
      this.axisX = [];
    ...
    m.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          u.targetCanvas = null;
          this.animatedRender &&
            ((u.targetCanvas = ta(this.width, this.height)),
          ...
          "line" === u.type
            ? (z = this.renderLine(u))
            : "stepLine" === u.type
            ? (z = this.renderStepLine(u))
            : "spline" === u.type
            ? (z = this.renderSpline(u))
            : "column" === u.type
            ? (z = this.renderColumn(u))
            : "bar" === u.type
            ? (z = this.renderBar(u))
            : "area" === u.type
            ? (z = this.renderArea(u))
            : "stepArea" === u.type
            ? (z = this.renderStepArea(u))
            : "splineArea" === u.type
            ? (z = this.renderSplineArea(u))
            : "stackedColumn" === u.type
            ? (z = this.renderStackedColumn(u))
            : "stackedColumn100" === u.type
            ? (z = this.renderStackedColumn100(u))
            : "stackedBar" === u.type
            ? (z = this.renderStackedBar(u))
            : "stackedBar100" === u.type
            ? (z = this.renderStackedBar100(u))
            : "stackedArea" === u.type
            ? (z = this.renderStackedArea(u))
            : "stackedArea100" === u.type
            ? (z = this.renderStackedArea100(u))
            : "bubble" === u.type
            ? (z = z = this.renderBubble(u))
            : "scatter" === u.type
            ? (z = this.renderScatter(u))
            : "pie" === u.type
            ? this.renderPie(u)
            : "doughnut" === u.type
            ? this.renderPie(u)
            : "funnel" === u.type
            ? (z = this.renderFunnel(u))
            : "pyramid" === u.type
            ? (z = this.renderFunnel(u))
            : "candlestick" === u.type
            ? (z = this.renderCandlestick(u))
            : "ohlc" === u.type
            ? (z = this.renderCandlestick(u))
            : "rangeColumn" === u.type
            ? (z = this.renderRangeColumn(u))
            : "error" === u.type
            ? (z = this.renderError(u))
            : "rangeBar" === u.type
            ? (z = this.renderRangeBar(u))
            : "rangeArea" === u.type
            ? (z = this.renderRangeArea(u))
            : "rangeSplineArea" === u.type
            ? (z = this.renderRangeSplineArea(u))
            : "waterfall" === u.type
            ? (z = this.renderWaterfall(u))
            : "boxAndWhisker" === u.type && (z = this.renderBoxAndWhisker(u));
          for (var h = 0; h < u.dataSeriesIndexes.length; h++)
            this._dataInRenderedOrder.push(this.data[u.dataSeriesIndexes[h]]);
          this.animatedRender &&
            ((u.targetCanvasCtx.miterLimit = e), z && c.push(z));
        }
      ...
      if (0 < c.length)
          ...
          p._animator.animate(
            ...
            function (a) {
              ...
              p.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(p.width * ja),
                Math.floor(p.height * ja),
                0,
                0,
                p.width,
                p.height
              ...
              for (var e = 0; e < c.length; e++)
                (z = c[e]),
                  1 > a && "undefined" !== typeof z.startTimePercent
                    ? a >= z.startTimePercent &&
                      z.animationCallback(
                        z.easingFunction(
                          a - z.startTimePercent,
                          0,
                          1,
                          1 - z.startTimePercent
                        ),
                        z
                      )
                    : z.animationCallback(z.easingFunction(a, 0, 1, 1), z);
            ...
            function () {
              ...
              for (var a = 0; a < p.plotInfo.plotTypes.length; a++)
                for (
                  var e = p.plotInfo.plotTypes[a], d = 0;
        ...
        if (p._breaksCanvas)
          ...
          else for (h = 0; h < p._axes.length; h++) p._axes[h].createMask();
          ...
          if ("normal" === u.axisPlacement || "xySwapped" === u.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (u.dataPoints[z].x && u.dataPoints[z].x.getTime) ||
            "dateTime" === u.xValueType
          )
            f = !0;
          for (z = 0; z < u.dataPoints.length; z++) {
            "undefined" === typeof u.dataPoints[z].x &&
              (u.dataPoints[z].x = z + (a.axisX.logarithmic ? 1 : 0));
            u.dataPoints[z].x.getTime
              ? ((f = !0), (b = u.dataPoints[z].x.getTime()))
              : (b = u.dataPoints[z].x);
            e = u.dataPoints[z].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < z) {
              if (a.axisX.logarithmic) {
                var A = b / u.dataPoints[z - 1].x;
                1 > A && (A = 1 / A);
                c.minDiff > A && 1 !== A && (c.minDiff = A);
              } else
                (A = b - u.dataPoints[z - 1].x),
                  0 > A && (A *= -1),
                  c.minDiff > A && 0 !== A && (c.minDiff = A);
              null !== e &&
                null !== u.dataPoints[z - 1].y &&
                (a.axisY.logarithmic
                  ? ((A = e / u.dataPoints[z - 1].y),
                    1 > A && (A = 1 / A),
            ...
            if (b < q && !h) null !== e && (n = b);
              ...
              u.dataPoints[z].label &&
                (a.axisX.labels[b] = u.dataPoints[z].label);
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          if ("normal" === n.axisPlacement || "xySwapped" === n.axisPlacement)
            var O = a.axisX.sessionVariables.newViewportMinimum
                ? a.axisX.sessionVariables.newViewportMinimum
                : this.options.axisX && this.options.axisX.viewportMinimum
                ? this.options.axisX.viewportMinimum
                : this.options.axisX && this.options.axisX.minimum
          ...
          for (q = 0; q < n.dataPoints.length; q++) {
            ...
            n.dataPoints[q].x.getTime
              ? ((f = !0), (b = n.dataPoints[q].x.getTime()))
              : (b = n.dataPoints[q].x);
            ...
            if (0 < q) {
              if (a.axisX.logarithmic) {
                var m = b / n.dataPoints[q - 1].x;
                1 > m && (m = 1 / m);
                c.minDiff > m && 1 !== m && (c.minDiff = m);
              } else
                (m = b - n.dataPoints[q - 1].x),
                  0 > m && (m *= -1),
              ...
              null === n.dataPoints[q].y
                ...
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                  0 <= e
                    ? l[b]
                      ? (l[b] += e)
                      : ((l[b] = e), (z = Math.min(e, z)))
                    : u[b]
                    ? (u[b] += e)
                    : ((u[b] = e), (h = Math.max(e, h))));
            }
          }
          a.axisY.scaleBreaks &&
        ...
        for (q in l)
          l.hasOwnProperty(q) &&
            !isNaN(q) &&
            ((a = l[q]),
            a < d.min && (d.min = Math.min(a, z)),
            a > d.max && (d.max = a),
            q < c.viewPortMin ||
              q > c.viewPortMax ||
              (a < d.viewPortMin && (d.viewPortMin = Math.min(a, z)),
          ...
          if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement)
            var k = a.axisX.sessionVariables.newViewportMinimum
              ...
              m = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (p.dataPoints[n].x && p.dataPoints[n].x.getTime) ||
            "dateTime" === p.xValueType
          )
            f = !0;
          for (n = 0; n < p.dataPoints.length; n++) {
            "undefined" === typeof p.dataPoints[n].x &&
              (p.dataPoints[n].x = n + (a.axisX.logarithmic ? 1 : 0));
            p.dataPoints[n].x.getTime
              ? ((f = !0), (b = p.dataPoints[n].x.getTime()))
              : (b = p.dataPoints[n].x);
            ...
            if (0 < n) {
              if (a.axisX.logarithmic) {
                ...
                (t = b - p.dataPoints[n - 1].x),
                  0 > t && (t *= -1),
                  c.minDiff > t && 0 !== t && (c.minDiff = t);
              r(e) ||
                null === p.dataPoints[n - 1].y ||
                (a.axisY.logarithmic
                  ? 0 < e &&
                    ((t = e / p.dataPoints[n - 1].y),
                    1 > t && (t = 1 / t),
            ...
            if (b < k && !q) null !== e && (A = b);
              ...
              p.dataPoints[n].label &&
                (a.axisX.labels[b] = p.dataPoints[n].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
              null === e
                ? c.viewPortMin === b && A < b && (c.viewPortMin = A)
                : ((a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e),
                  0 <= e ? (l = !0) : 0 > e && (u = !0),
                  (z[b] = z[b] ? z[b] + Math.abs(e) : Math.abs(e)));
            }
          }
          ...
          if ("normal" === h.axisPlacement || "xySwapped" === h.axisPlacement)
            var m = a.axisX.sessionVariables.newViewportMinimum
              ...
              t = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (h.dataPoints[p].x && h.dataPoints[p].x.getTime) ||
            "dateTime" === h.xValueType
          )
            u = !0;
          for (p = 0; p < h.dataPoints.length; p++) {
            "undefined" === typeof h.dataPoints[p].x &&
              (h.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0));
            h.dataPoints[p].x.getTime
              ? ((u = !0), (b = h.dataPoints[p].x.getTime()))
              : (b = h.dataPoints[p].x);
            ...
            0 < p &&
              ...
              e &&
                null !== e[0] &&
                h.dataPoints[p - 1].y &&
                null !== h.dataPoints[p - 1].y[0] &&
                (a.axisY.logarithmic
                  ? ((A = e[0] / h.dataPoints[p - 1].y[0]),
                    1 > A && (A = 1 / A),
                    d.minDiff > A && 1 !== A && (d.minDiff = A))
                  : ((A = e[0] - h.dataPoints[p - 1].y[0]),
                    0 > A && (A *= -1),
            ...
            if (!(b < m) || n) {
              ...
              h.dataPoints[p].label &&
                (a.axisX.labels[b] = h.dataPoints[p].label);
              b < c.viewPortMin && (c.viewPortMin = b);
              b > c.viewPortMax && (c.viewPortMax = b);
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (z = 0; z < u.dataPoints.length; z++)
            "undefined" !== typeof u.dataPoints[z].isCumulativeSum &&
            !0 === u.dataPoints[z].isCumulativeSum
              ? ((u.dataPointEOs[z].cumulativeSumYStartValue = 0),
                (u.dataPointEOs[z].cumulativeSum =
                  0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum),
                (u.dataPoints[z].y =
                  0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum))
              : "undefined" !== typeof u.dataPoints[z].isIntermediateSum &&
                !0 === u.dataPoints[z].isIntermediateSum
              ? ((u.dataPointEOs[z].cumulativeSumYStartValue = n),
                (u.dataPointEOs[z].cumulativeSum =
                  0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum),
                (u.dataPoints[z].y = 0 === z ? 0 : b),
                (n = 0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof u.dataPoints[z].y
                    ? 0
                    : u.dataPoints[z].y),
                (u.dataPointEOs[z].cumulativeSumYStartValue =
                  0 === z ? 0 : u.dataPointEOs[z - 1].cumulativeSum),
                (u.dataPointEOs[z].cumulativeSum =
                  0 === z ? e : u.dataPointEOs[z - 1].cumulativeSum + e),
                (b += e));
          for (z = 0; z < u.dataPoints.length; z++)
            if (
              ("undefined" === typeof u.dataPoints[z].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              u.dataPointEOs[z].cumulativeSum < d.min &&
                (d.min = u.dataPointEOs[z].cumulativeSum),
              u.dataPointEOs[z].cumulativeSum > d.max &&
                (d.max = u.dataPointEOs[z].cumulativeSum),
              0 < z &&
                (a.axisX.logarithmic
                  ? ((n = b / u.dataPoints[z - 1].x),
                    1 > n && (n = 1 / n),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        u.dataPointEOs[z].cumulativeSum /
                        u.dataPointEOs[z - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < z &&
                (u.dataPointEOs[z - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = u.dataPointEOs[z - 1].cumulativeSum),
                u.dataPointEOs[z - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = u.dataPointEOs[z - 1].cumulativeSum));
              u.dataPointEOs[z].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = u.dataPointEOs[z].cumulativeSum);
              u.dataPointEOs[z].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = u.dataPointEOs[z].cumulativeSum);
            }
          u.axisX.valueType = u.xValueType = f ? "dateTime" : "number";
        }
    };
    m.prototype.calculateAutoBreaks = function () {
                  ...
                  if (
                    (b &&
                      ((n =
                        ...
                        100),
                      (g = k.dataPoints[u].x.getTime
                        ? k.dataPoints[u].x.getTime()
                        : k.dataPoints[u].x),
                      (n = Math.floor((g - h) / n)),
                      g < f[n].min && (f[n].min = g),
                      g > f[n].max && (f[n].max = g)),
                    ...
                    if (
                      (g =
                        "waterfall" === a.type
                          ? k.dataPointEOs[u].cumulativeSum
                          : k.dataPoints[u].y) &&
                      g.length
                    )
                      for (var s = 0; s < g.length; s++)
                        (n = Math.floor((g[s] - p) / m)),
                          g[s] < d[n].min && (d[n].min = g[s]),
                          g[s] > d[n].max && (d[n].max = g[s]);
                    else
                      r(g) ||
                        ((n = Math.floor((g - p) / m)),
                        g < d[n].min && (d[n].min = g),
            ...
            if (!(4 > p.dataPoints.length))
              for (h = 0; h < p.dataPoints.length; h++)
                (g =
                  ...
                  100),
                  (b = p.dataPoints[h].x.getTime
                    ? p.dataPoints[h].x.getTime()
                    : p.dataPoints[h].x),
                  (g = Math.floor((b - c) / g)),
                  b < f[g].min && (f[g].min = b),
                  b > f[g].max && (f[g].max = b);
      ...
      if (f) {
        for (l = 0; l < this.plotInfo.plotTypes.length; l++)
          for (
            f = this.plotInfo.plotTypes[l], u = 0;
        ...
        for (l = 0; l < this._axes.length; l++)
          if (this._axes[l].dataInfo._dataRanges) {
            ...
            if (this._axes[l].scaleBreaks.customBreaks)
              for (
                u = 0;
                u < this._axes[l].scaleBreaks.customBreaks.length;
                u++
              )
                for (b = 0; b < f.length; b++)
                  if (
                    (this._axes[l].scaleBreaks.customBreaks[u].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[l].scaleBreaks.customBreaks[u].endValue) ||
                    (this._axes[l].scaleBreaks.customBreaks[u].startValue <=
                      f[b].start &&
                      f[b].start <=
                        this._axes[l].scaleBreaks.customBreaks[u].endValue) ||
      ...
      m.capturedEventParam &&
        ...
        b.hasOwnProperty(c) &&
          ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture
            ? (a.target !== b.chart.overlaidCanvas && s) ||
    ...
    m.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (
        ...
        (("axisX" === this._axes[n].type && f) ||
          ("axisY" === this._axes[n].type && l)) &&
          h.push(this._axes[n]);
      for (l = 0; l < h.length; l++) {
        ...
        if (q > g)
          var A = g,
            ...
            q = A;
        if (n.scaleBreaks)
          for (A = 0; !f && A < n.scaleBreaks._appliedBreaks.length; A++)
            f =
              n.scaleBreaks._appliedBreaks[A].startValue <= q &&
              n.scaleBreaks._appliedBreaks[A].endValue >= g;
        if (isFinite(n.dataInfo.minDiff))
          if (
            ((A = n.getApparentDifference(q, g, null, !0)),
            !(
              f ||
              (!(
                this.panEnabled &&
                ...
                ((n.logarithmic && A < Math.pow(n.dataInfo.minDiff, 3)) ||
                  (!n.logarithmic && A < 3 * Math.abs(n.dataInfo.minDiff)))) ||
              q < n.minimum ||
              g > n.maximum
            ))
          )
            z.push(n), p.push({ val1: q, val2: g }), (u = !0);
          else if (!e) {
            u = !1;
            break;
          }
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        var l = ma("indexLabelFontWeight", h.dataPoint, h.dataSeries),
          ...
          A = ma("indexLabelLineDashType", h.dataPoint, h.dataSeries),
          k = ma("indexLabelLineColor", h.dataPoint, h.dataSeries),
          m = r(h.dataPoint.indexLabelLineThickness)
            ? r(h.dataSeries.options.indexLabelLineThickness)
              ? 0
        ...
        var C = h.dataPoint.indexLabelFormatter
        ...
        if (null !== C && "" !== C) {
          ...
          if ("stackedarea100" === p) {
            ...
            if (
              h.dataPoint.x < B.viewportMinimum ||
              h.dataPoint.x > B.viewportMaximum ||
              Math.max.apply(null, h.dataPoint.y) < y.viewportMinimum ||
              Math.min.apply(null, h.dataPoint.y) > y.viewportMaximum
            )
              continue;
          } else if (
            0 <= p.indexOf("line") ||
            ...
            if (
              h.dataPoint.x < B.viewportMinimum ||
              h.dataPoint.x > B.viewportMaximum ||
              h.dataPoint.y < y.viewportMinimum ||
              h.dataPoint.y > y.viewportMaximum
            )
              continue;
          } else if (
            0 <= p.indexOf("column") ||
            "waterfall" === p ||
            ("error" === p && !h.axisSwapped)
          ) {
            if (
              h.dataPoint.x < B.viewportMinimum ||
              h.dataPoint.x > B.viewportMaximum ||
          ...
          e = l = 2;
          "horizontal" === x
            ? ((u = g.width), (z = g.height))
            : ((z = g.width), (u = g.height));
              ...
              : ((e = Math.max(h.bounds.y1, c.y1)),
                ...
                (b =
                  0 <= p.indexOf("range") || "error" === p
                    ? 0 < J
                      ? Math.max(h.bounds.y1, c.y1) + z / 2 + l
                      : Math.min(h.bounds.y2, c.y2) - z / 2 - l
                    : (Math.max(h.bounds.y1, c.y1) +
                        Math.min(h.bounds.y2, c.y2)) /
                      2),
                0 < J
                  ? ((q = Math.max(h.point.y, b)),
                    q < e &&
                      ("bubble" === p || "scatter" === p) &&
                      (q = Math.max(h.point.y - z - l, c.y1 + l)))
                  : ((q = Math.min(h.point.y, b)),
                    q > f - z - l &&
                      ("bubble" === p || "scatter" === p) &&
                      (q = Math.min(h.point.y + l, c.y2 - z - l))),
                (q = Math.min(q, f)));
          } else
            0 <= p.indexOf("line") ||
            0 <= p.indexOf("area") ||
            0 <= p.indexOf("scatter")
              ...
              "inside" !== t
                ? ((l = c.x1),
                  ...
                  0 > J
                    ? ((n =
                        h.point.x - ("horizontal" === x ? u : u / 2) - e - b),
                      n < l &&
                        ((n =
                          "auto" === t
                            ? Math.max(h.point.x, l) + e + b
                            : l + e + b),
                        (v = n + u > h.point.x)))
                    : ((n =
                        h.point.x + ("horizontal" === x ? 0 : u / 2) + e + b),
                      n > f - u - e - b &&
                        ((n =
                          "auto" === t
                            ? Math.min(h.point.x, f) -
                              ("horizontal" === x ? u : u / 2) -
                              e -
                              b
                            : f - u - e - b),
                        (v = n < h.point.x))))
                : ((l = Math.max(h.bounds.x1, c.x1)),
                  Math.min(h.bounds.x2, c.x2),
                  (b =
                    0 <= p.indexOf("range") || "error" === p
                      ? 0 > J
                        ? Math.max(h.bounds.x1, c.x1) + u / 2 + e
                        : Math.min(h.bounds.x2, c.x2) - u / 2 - e
                      : (Math.max(h.bounds.x1, c.x1) +
                          Math.min(h.bounds.x2, c.x2)) /
                        2),
                  (n =
                    0 > J
                      ? Math.max(h.point.x, b) -
                        ("horizontal" === x ? u / 2 : 0)
                      : Math.min(h.point.x, b) - u / 2),
                  (n = Math.max(n, l)));
          "vertical" === x && (q += z / 2);
          g.x = n;
          g.y = q;
          ...
          m &&
            ...
            d.setLineDash && d.setLineDash(Q(A, m)),
            d.beginPath(),
            d.moveTo(h.point.x, h.point.y),
            0 <= p.indexOf("bar") || ("error" === p && h.axisSwapped)
              ? d.lineTo(
                  n -
                    (0 < h.direction ? 0 : -u) +
                    ("vertical" === x ? -u / 2 : 0),
              ...
              : 0 <= p.indexOf("column") || ("error" === p && !h.axisSwapped)
              ? d.lineTo(
                  n + ("horizontal" === x ? u / 2 : 0),
                  q +
                    ((0 < h.direction ? z : -z) + ("vertical" === x ? -z : 0)) /
                      2
                )
              : d.lineTo(
                  n + ("horizontal" === x ? u / 2 : 0),
                  q +
                    ((q < h.point.y ? z : -z) + ("vertical" === x ? -z : 0)) / 2
                ),
            d.stroke());
        }
      }
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (h = this._indexLabels[a]),
          (g = ma("indexLabelBackgroundColor", h.dataPoint, h.dataSeries)),
          (h.dataSeries.indexLabelBackgroundColor = r(g)
            ? s
              ? "transparent"
              : null
            : g);
    ...
    m.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          var A = h._colorSet,
            k = (A = h.lineColor = h.options.lineColor
              ? h.options.lineColor
              : A[0]);
          c.strokeStyle = A;
          var m = !0,
          ...
          if (0 < p.length) {
            for (var J = !1, t = 0; t < p.length; t++)
              if (
                ((x = p[t].x.getTime ? p[t].x.getTime() : p[t].x),
                !(
                ...
                if ("number" !== typeof p[t].y)
                  0 < t &&
                    !(h.connectNullData || J || m) &&
                    (c.stroke(), s && b.stroke()),
                    (J = !0);
                else {
                  ...
                  m || J
                    ? (!m && h.connectNullData
                        ? (c.setLineDash &&
                            ...
                            c.beginPath(),
                            c.moveTo(l.x, l.y),
                            (n = h.nullDataLineDashType),
                            c.setLineDash(q)),
                          c.lineTo(x, r),
                          s && b.lineTo(x, r))
                        : (c.beginPath(),
                          c.moveTo(x, r),
                          s && (b.beginPath(), b.moveTo(x, r))),
                      (J = m = !1))
                    : (c.lineTo(x, r),
                      s && b.lineTo(x, r),
                      0 == t % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(x, r),
                        s && (b.stroke(), b.beginPath(), b.moveTo(x, r))));
                  l = { x: x, y: r };
                  t < p.length - 1 &&
                    (k !== (p[t].lineColor || A) ||
                      n !== (p[t].lineDashType || h.lineDashType)) &&
                    (c.stroke(),
                    c.beginPath(),
                    c.moveTo(x, r),
                    (k = p[t].lineColor || A),
                    ...
                    c.setLineDash &&
                      (p[t].lineDashType
                        ? ((n = p[t].lineDashType),
                          c.setLineDash(Q(n, h.lineThickness)))
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < p.length) {
            for (var J = !1, t = 0; t < p.length; t++)
              if (
                ((x = p[t].getTime ? p[t].x.getTime() : p[t].x),
                !(
                  x < a.axisX.dataInfo.viewPortMin ||
                  (x > a.axisX.dataInfo.viewPortMax &&
                    (!h.connectNullData || !J))
                  ...
                  t < p.length - 1 &&
                    ...
                    c.setLineDash &&
                      (p[t].lineDashType
                        ...
                        : ((n = h.lineDashType), c.setLineDash(g))));
                  if (0 < p[t].markerSize || 0 < h.markerSize)
                    (B = h.getMarkerProperties(t, x, r, c)),
                      f.push(B),
                      (y = S(y)),
                      s &&
                        f.push({
        ...
        for (var l = [], u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < p.length)
            for (x = !1, m = 0; m < p.length; m++)
              if (
                ((t = p[m].getTime ? p[m].x.getTime() : p[m].x),
                !(
                ...
                if ("number" !== typeof p[m].y)
                  0 < m &&
                    ...
                    (h.connectNullData
                      ? b.setLineDash &&
                        ...
                        (h.options.nullDataLineDashType ||
                          !p[m - 1].lineDashType) &&
                        ((r[r.length - 1].newLineDashArray = q),
                        (n = h.nullDataLineDashType))
                      : (d(r), (r = []))),
                    (x = !0);
                else {
                  ...
                  m < p.length - 1 &&
                    (k !== (p[m].lineColor || A) ||
                      n !== (p[m].lineDashType || h.lineDashType)) &&
                    ((k = p[m].lineColor || A),
                    (r[r.length - 1].newStrokeStyle = k),
                    b.setLineDash &&
                      (p[m].lineDashType
                        ? ((n = p[m].lineDashType),
                          (r[r.length - 1].newLineDashArray = Q(
                        ...
                        : ((n = h.lineDashType),
                          (r[r.length - 1].newLineDashArray = g))));
    ...
    m.prototype.renderColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < A.length)
            for (
              var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0;
              f < A.length;
              f++
            )
              if (
                (A[f].getTime ? (z = A[f].x.getTime()) : (z = A[f].x),
                !(
                ...
                l = a.axisX.reversed
                  ...
                  : (l -
                      ...
                      (a.previousDataSeriesCount + p) * n) <<
                    0;
                var m = a.axisX.reversed ? (l - n) << 0 : (l + n) << 0,
                  t;
                0 <= A[f].y ? (t = h) : ((t = u), (u = h));
                u > t && ((b = u), (u = t), (t = b));
                b = A[f].color
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++)
              if (
                ((b = t[h].x.getTime ? t[h].x.getTime() : t[h].x),
                !(
                ...
                if (
                  ...
                  (z[b] = t[h].y + (z[b] ? z[b] : 0)),
                    (B = a.axisY.convertValueToPixel(z[b])),
                    (n = "undefined" !== typeof l[b] ? l[b] : q),
                    (l[b] = B);
                else if (
                  ((n = a.axisY.convertValueToPixel(t[h].y)), 0 <= t[h].y)
                ) {
    ...
    m.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < t.length)
            for (
              var r = 5 < g && m.bevelEnabled ? !0 : !1, h = 0;
              h < t.length;
              h++
            )
              if (
                ...
                if (
                  ...
                  (z[b] = n + ("undefined" !== typeof z[b] ? z[b] : 0)),
                    (B = a.axisY.convertValueToPixel(z[b])),
                    (n = l[b] ? l[b] : q),
                    (l[b] = B);
                  ...
                  n -= y;
                  B = q - y;
                  a.dataSeriesIndexes.length - 1 === A &&
                    1 >= Math.abs(e.y1 - n) &&
                    (n = e.y1);
                  f[b] = y + (B - n);
                } else
                  (y = "undefined" !== typeof l[b] ? l[b] : 0),
                    (B = n + y),
                    (n = q + y),
                    a.dataSeriesIndexes.length - 1 === A &&
                      1 >= Math.abs(e.y2 - B) &&
          ...
          if (0 < t.length) {
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                var C =
                    (n - (a.plotType.plotUnits.length * g) / 2 + a.index * g) <<
                    0,
                  J = (C + g) << 0,
                  B;
                if (
                  ...
                  (z[b] = t[h].y + (z[b] ? z[b] : 0)),
                    (p = l[b] ? l[b] : q),
                    (l[b] = B = a.axisY.convertValueToPixel(z[b]));
                else if (
                  ((p = a.axisY.convertValueToPixel(t[h].y)), 0 <= t[h].y)
                ) {
                  var y = f[b] ? f[b] : 0;
                  B = q + y;
                  p += y;
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (z[b] = C + (z[b] ? z[b] : 0)),
                    (p = l[b] ? l[b] : q),
                    (l[b] = C = a.axisY.convertValueToPixel(z[b]));
    ...
    m.prototype.renderArea = function (a) {
      ...
      function b() {
        B &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          s && (l.lineTo(m, J), l.lineTo(B.x, J), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(m, t),
          l.beginPath(),
          l.moveTo(m, t),
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < A.length) {
            ...
            for (var ha = !0; k < A.length; k++)
              if (
                ((r = A[k].x.getTime ? A[k].x.getTime() : A[k].x),
                !(
                  r < a.axisX.dataInfo.viewPortMin ||
                  (r > a.axisX.dataInfo.viewPortMax &&
                    (!g.connectNullData || !ha))
                ))
              )
                if ("number" !== typeof A[k].y)
                  g.connectNullData || ha || d || b(), (ha = !0);
                else {
                  ...
                  k < A.length - 1 &&
                    (w !== (A[k].lineColor || v) ||
                      c !== (A[k].lineDashType || g.lineDashType)) &&
                    (b(),
                    (w = A[k].lineColor || v),
                    (f.strokeStyle = w),
                    f.setLineDash &&
                      (A[k].lineDashType
                        ? ((c = A[k].lineDashType),
                          f.setLineDash(Q(c, g.lineThickness)))
                        : ((c = g.lineDashType), f.setLineDash(P))));
                  ...
                  0 !== A[k].markerSize &&
                    (0 < A[k].markerSize || 0 < g.markerSize) &&
                    ((r = g.getMarkerProperties(k, m, t, f)),
                    z.push(r),
                    ($ = S($)),
                    s &&
                      z.push({
        ...
        for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
          ...
          if (0 < n.length) {
            ...
            for (A = !1; q < n.length; q++)
              if (
                ((g = n[q].x.getTime ? n[q].x.getTime() : n[q].x),
                !(
                ...
                if ("number" !== typeof n[q].y)
                    ...
                    (p.connectNullData
                      ? b.setLineDash &&
                        ...
                        (p.options.nullDataLineDashType ||
                          !n[q - 1].lineDashType) &&
                        ((r[r.length - 1].newLineDashArray = w),
                        (y = p.nullDataLineDashType))
                      : (d(), (r = []))),
                    (A = !0);
                else {
                  ...
                  q < n.length - 1 &&
                    (B !== (n[q].lineColor || J) ||
                      y !== (n[q].lineDashType || p.lineDashType)) &&
                    ((B = n[q].lineColor || J),
                    (r[r.length - 1].newStrokeStyle = B),
                    b.setLineDash &&
                      (n[q].lineDashType
                        ? ((y = n[q].lineDashType),
                          (r[r.length - 1].newLineDashArray = Q(
                        ...
                        : ((y = p.lineDashType),
                          (r[r.length - 1].newLineDashArray = D))));
                  if (
                    0 !== n[q].markerSize &&
                    (0 < n[q].markerSize || 0 < p.markerSize)
                  ) {
              ...
              if (
                ...
                "number" !== typeof A[k].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(r)),
                    ...
                    d || c
                      ? (!d && g.connectNullData
                          ? (f.setLineDash &&
                              ...
                              (t = c),
                              (B = p),
                              (K = g.nullDataLineDashType),
                              f.setLineDash(P)),
                            f.lineTo(m, $),
                            f.lineTo(m, t),
                            s && (l.lineTo(m, $), l.lineTo(m, t)))
                          : (f.beginPath(),
                            f.moveTo(m, t),
                            s && (l.beginPath(), l.moveTo(m, t)),
                            (B = { x: m, y: t })),
                    ...
                    k < A.length - 1 &&
                      (w !== (A[k].lineColor || v) ||
                        K !== (A[k].lineDashType || g.lineDashType)) &&
                      (b(),
                      (w = A[k].lineColor || v),
                      (f.strokeStyle = w),
                      f.setLineDash &&
                        (A[k].lineDashType
                          ? ((K = A[k].lineDashType),
                            f.setLineDash(Q(K, g.lineThickness)))
                          : ((K = g.lineDashType), f.setLineDash(D)))),
                    (r = g.dataPointIds[k]),
    ...
    m.prototype.renderStackedArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], J = 0; J < a.dataSeriesIndexes.length; J++) {
          var B = a.dataSeriesIndexes[J],
            y = this.data[B],
            v = y.dataPoints;
          y.dataPointIndexes = [];
          for (q = 0; q < v.length; q++)
            (B = v[q].x.getTime ? v[q].x.getTime() : v[q].x),
              (y.dataPointIndexes[B] = q),
              e[B] || (p.push(B), (e[B] = !0));
          p.sort(Pa);
        }
          ...
          if (0 < p.length) {
            ...
            for (var $ = !0, q = 0; q < p.length; q++) {
              var f = p[q],
                ia = null,
                ia =
                  0 <= y.dataPointIndexes[f]
                    ? v[y.dataPointIndexes[f]]
                    : { x: f, y: null };
              if (
                !(
                ...
                if ("number" !== typeof ia.y)
                  ...
                  x || $
                    ? (!x && y.connectNullData
                        ? (b.setLineDash &&
                            (y.options.nullDataLineDashType ||
                              (C === y.lineDashType &&
                                y.lineDashType !== y.nullDataLineDashType)) &&
                            ((x = h.pop()),
                            (C = h[h.length - 1]),
                            d(),
                            b.moveTo(t.x, t.y),
                            h.push(C),
                            h.push(x),
                            (C = y.nullDataLineDashType),
                            b.setLineDash(P)),
                          b.lineTo(g, k),
                          s && r.lineTo(g, k))
                        : (b.beginPath(),
                          b.moveTo(g, k),
                          s && (r.beginPath(), r.moveTo(g, k))),
                      ($ = x = !1))
                    : (b.lineTo(g, k),
                      s && r.lineTo(g, k),
                      0 == q % 250 &&
                  ...
                  q < v.length - 1 &&
                    (K !== (v[q].lineColor || w) ||
                      C !== (v[q].lineDashType || y.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, k),
                    h.push({ x: g, y: m - na }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((C = v[q].lineDashType),
                          b.setLineDash(Q(C, y.lineThickness)))
                        : ((C = y.lineDashType), b.setLineDash(D))));
                  ...
                  0 <= y.dataPointIndexes[f] &&
                    0 !== ia.markerSize &&
                    (0 < ia.markerSize || 0 < y.markerSize) &&
                    ((na = y.getMarkerProperties(
                      y.dataPointIndexes[f],
                      g,
                      k,
                      b
                    )),
    ...
    m.prototype.renderStackedArea100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.clip();
        s && (C.beginPath(), C.rect(l.x1, l.y1, l.width, l.height), C.clip());
        for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          for (q = 0; q < w.length; q++)
            (B = w[q].x.getTime ? w[q].x.getTime() : w[q].x),
              (y.dataPointIndexes[B] = q),
              e[B] || (p.push(B), (e[B] = !0));
          p.sort(Pa);
        }
        for (v = 0; v < a.dataSeriesIndexes.length; v++) {
          ...
          h = [];
          if (0 < p.length) {
            var e = y._colorSet[q % y._colorSet.length],
            ...
            for (var $ = !0, q = 0; q < p.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof ia.y)
                  ...
                  O || $
                    ? (!O && y.connectNullData
                        ? (b.setLineDash &&
                            ...
                            h.push(t),
                            h.push(O),
                            (t = y.nullDataLineDashType),
                            b.setLineDash(P)),
                          b.lineTo(g, m),
                          s && C.lineTo(g, m))
                        : (b.beginPath(),
                          b.moveTo(g, m),
                          s && (C.beginPath(), C.moveTo(g, m))),
                      ($ = O = !1))
                    : (b.lineTo(g, m),
                      s && C.lineTo(g, m),
                      0 == q % 250 &&
                  ...
                  q < w.length - 1 &&
                    (K !== (w[q].lineColor || D) ||
                      t !== (w[q].lineDashType || y.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, m),
                    h.push({ x: g, y: x - ca }),
                    ...
                    b.setLineDash &&
                      (w[q].lineDashType
                        ? ((t = w[q].lineDashType),
                          b.setLineDash(Q(t, y.lineThickness)))
                        : ((t = y.lineDashType), b.setLineDash(E))));
                  if (0 <= y.dataPointIndexes[f]) {
                  ...
                  0 <= y.dataPointIndexes[f] &&
                    0 !== ia.markerSize &&
                    (0 < ia.markerSize || 0 < y.markerSize) &&
                    ((ca = y.getMarkerProperties(q, g, m, b)),
                    u.push(ca),
                    (f = S(F)),
                    s &&
                      u.push({
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
          ...
          if (0 < x.length)
            for (
              var C = 5 < m && t.bevelEnabled ? !0 : !1, u = 0;
              u < x.length;
              u++
            )
              if (
                (x[u].getTime ? (g = x[u].x.getTime()) : (g = x[u].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                  ...
                  "number" === typeof x[u].y[2] &&
                  "number" === typeof x[u].y[3])
              ) {
                ...
                "candlestick" === t.type
                  ? (c.moveTo(k - w, p),
                    c.lineTo(k - w, Math.min(h, q)),
                    c.stroke(),
                    c.moveTo(k - w, Math.max(h, q)),
                    c.lineTo(k - w, n),
                    c.stroke(),
                    da(
                      c,
                      ...
                      B,
                      Math.max(h, q),
                      x[u].y[0] <= x[u].y[3] ? t.risingColor : f,
                      y,
                      e,
                      C,
                      C,
                    ...
                    s &&
                      ...
                      (b.strokeStyle = e),
                      b.moveTo(k - w, p),
                      b.lineTo(k - w, Math.min(h, q)),
                      b.stroke(),
                      b.moveTo(k - w, Math.max(h, q)),
                      b.lineTo(k - w, n),
                      b.stroke(),
                      da(
                        b,
                ...
                (x[u].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: x[u],
                    dataSeries: t,
                    point: { x: v + (B - v) / 2, y: a.axisY.reversed ? n : p },
                    direction: 1,
                    bounds: {
                      x1: v,
                      y1: Math.min(p, n),
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var ga = !1, ga = !!a.axisY.reversed, O = 0;
          O < a.dataSeriesIndexes.length;
          O++
        ) {
          ...
          if (0 < C.length)
            for (
              var v = 5 < m && x.bevelEnabled ? !0 : !1, l = 0;
              l < C.length;
              l++
            )
              if (
                (C[l].getTime ? (g = C[l].x.getTime()) : (g = C[l].x),
                !(
                  g < a.axisX.dataInfo.viewPortMin ||
                  g > a.axisX.dataInfo.viewPortMax
                ) &&
                ...
                var B = (u - m / 2) << 0,
                  ...
                  K = C[l].whiskerColor
                    ...
                    : e,
                  P =
                    "number" === typeof C[l].whiskerThickness
                      ? C[l].whiskerThickness
                      : "number" === typeof x.options.whiskerThickness
                      ? x.whiskerThickness
                      : w,
                  E = C[l].whiskerDashType
                    ? C[l].whiskerDashType
                    : x.whiskerDashType,
                  $ = r(C[l].whiskerLength)
                    ? r(x.options.whiskerLength)
                      ? m
                      : x.whiskerLength
                    : C[l].whiskerLength,
                  $ =
                  ...
                  na = C[l].stemColor
                    ...
                    : e,
                  ca =
                    "number" === typeof C[l].stemThickness
                      ? C[l].stemThickness
                      : "number" === typeof x.options.stemThickness
                      ? x.stemThickness
                      : w,
                  F = 1 === Math.round(ca) % 2 ? 0.5 : 0,
                  I = C[l].stemDashType ? C[l].stemDashType : x.stemDashType,
                  G = C[l].lineColor
                    ? C[l].lineColor
                    : C[l].color
                    ? x.lineColor
                    ...
                    : e,
                  N =
                    "number" === typeof C[l].lineThickness
                      ? C[l].lineThickness
                ...
                0 < ca &&
                  ...
                  (c.strokeStyle = na),
                  (c.lineWidth = ca),
                  c.setLineDash && c.setLineDash(Q(I, ca)),
                  c.moveTo(u - F, h),
                  c.lineTo(u - F, k),
                  c.stroke(),
                  c.moveTo(u - F, n),
                ...
                0 < N &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(Q(T, N)),
                  (c.strokeStyle = G),
                  (c.lineWidth = N),
                  c.moveTo(B, q - M),
                  c.lineTo(y, q - M),
                ...
                0 < P &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(Q(E, P)),
                  (c.strokeStyle = K),
                  (c.lineWidth = P),
                  c.moveTo((u - $ / 2) << 0, n - ia),
                  c.lineTo((u + $ / 2) << 0, n - ia),
                ...
                s &&
                  ...
                  0 < ca &&
                    (b.moveTo(u - D - F, h),
                    b.lineTo(u - D - F, Math.max(k, n)),
                    b.stroke(),
                    b.moveTo(u - D - F, Math.min(k, n)),
                    b.lineTo(u - D - F, p),
                    b.stroke()),
                  da(
                    b,
                ...
                (C[l].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: C[l],
                    dataSeries: x,
                    point: { x: B + (y - B) / 2, y: a.axisY.reversed ? k : n },
                    direction: 1,
                    bounds: {
                      x1: B,
                      y1: Math.min(k, n),
    ...
    m.prototype.renderRangeColumn = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < g.length)
            for (
              var m = 5 < h && q.bevelEnabled ? !0 : !1, f = 0;
              f < g.length;
              f++
            )
              if (
                ...
                var ga = a.axisX.reversed
                    ? (b +
                        (a.plotType.totalDataSeries * h) / 2 -
                        (a.previousDataSeriesCount + p) * h) <<
                      0
                    : (b -
                        (a.plotType.totalDataSeries * h) / 2 +
                        (a.previousDataSeriesCount + p) * h) <<
    ...
    m.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        s &&
          ...
          this._eventManager.ghostCtx.clip());
        for (var O = 0, t = 0; t < this.data.length; t++)
          !this.data[t].type.match(/(bar|column)/gi) ||
            !this.data[t].visible ||
            (this.data[t].type.match(/(stacked)/gi) && O) ||
            O++;
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var C = a.dataSeriesIndexes[x],
            ...
            y = r(v._linkedSeries)
              ? !1
              : v._linkedSeries.type.match(/(bar|column)/gi) &&
                v._linkedSeries.visible
              ? !0
              : !1,
            D = 0;
          if (y)
            for (e = v._linkedSeries.id, t = 0; t < e; t++)
              !this.data[t].type.match(/(bar|column)/gi) ||
                !this.data[t].visible ||
                (this.data[t].type.match(/(stacked)/gi) && D) ||
                (this.data[t].type.match(/(range)/gi) && (f = !0), D++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          u = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (y ? O : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (u = this.options.dataPointMaxWidth
          ...
          t = this.options.dataPointWidth
            ...
            : (0.9 *
                (((b ? l.height : l.width) *
                  (a.axisX.logarithmic
                    ? Math.log(ga) / Math.log(a.axisX.range)
                    : Math.abs(ga) / Math.abs(a.axisX.range))) /
                  (y ? O : 1))) <<
              0;
          this.dataPointMaxWidth &&
            e > u &&
          ...
          if (0 < B.length)
            for (var E = v._colorSet, u = 0; u < B.length; u++) {
              var e = (v.lineColor = v.options.color ? v.options.color : E[0]),
                K = {
                  color: B[u].whiskerColor
                    ...
                    ? v.whiskerColor
                    : e,
                  thickness: r(B[u].whiskerThickness)
                    ? v.whiskerThickness
                    : B[u].whiskerThickness,
                  dashType: B[u].whiskerDashType
                    ? B[u].whiskerDashType
                    : v.whiskerDashType,
                  length: r(B[u].whiskerLength)
                    ? r(v.options.whiskerLength)
                      ? t
                      : v.options.whiskerLength
                    : B[u].whiskerLength,
                  trimLength: r(B[u].whiskerLength)
                    ? r(v.options.whiskerLength)
                      ? 50
                      : 0
                    : 0,
              ...
              if (
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (h + ((y ? O : 1) * t) / 2 - (y ? D - 1 : 0) * t) << 0
                      : (h - ((y ? O : 1) * t) / 2 + (y ? D - 1 : 0) * t) << 0),
                    (g = a.axisX.reversed ? (q - t) << 0 : (q + t) << 0))
                  : ((p = a.axisX.reversed
                      ? (k + ((y ? O : 1) * t) / 2 - (y ? D - 1 : 0) * t) << 0
                      : (k - ((y ? O : 1) * t) / 2 + (y ? D - 1 : 0) * t) << 0),
                    (n = a.axisX.reversed ? (p - t) << 0 : (p + t) << 0));
                !b && q > g && ((ha = q), (q = g), (g = ha));
                b && p > n && ((ha = p), (p = n), (n = ha));
                ha = v.dataPointIds[u];
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < m.length) {
            ...
            for (f = 0; f < m.length; f++)
              if (
                (m[f].getTime ? (h = m[f].x.getTime()) : (h = m[f].x),
                !(
                  ...
                  !r(m[f].y) &&
                  m[f].y.length &&
                  "number" === typeof m[f].y[0] &&
                  "number" === typeof m[f].y[1])
              ) {
    ...
    m.prototype.renderRangeArea = function (a) {
      function d() {
        if (x) {
          for (var a = null, c = k.length - 1; 0 <= c; c--)
            (a = k[c]), b.lineTo(a.x, a.y2), e.lineTo(a.x, a.y2);
          b.closePath();
          b.globalAlpha = p.fillOpacity;
          b.fill();
          b.globalAlpha = 1;
        ...
        for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
          ...
          if (0 < n.length) {
            ...
            for (var K = !0; g < n.length; g++)
              if (
                ((t = n[g].x.getTime ? n[g].x.getTime() : n[g].x),
                !(
                  t < a.axisX.dataInfo.viewPortMin ||
                  (t > a.axisX.dataInfo.viewPortMax &&
                    (!p.connectNullData || !K))
                ...
                if (
                  null !== n[g].y &&
                  n[g].y.length &&
                  "number" === typeof n[g].y[0] &&
                  "number" === typeof n[g].y[1]
                ) {
                  ...
                  q || K
                    ? (p.connectNullData && !q
                        ? (b.setLineDash &&
                            (p.options.nullDataLineDashType ||
                              (y === p.lineDashType &&
                                p.lineDashType !== p.nullDataLineDashType)) &&
                  ...
                  g < n.length - 1 &&
                    (B !== (n[g].lineColor || w) ||
                      y !== (n[g].lineDashType || p.lineDashType)) &&
                    (d(),
                    (B = n[g].lineColor || w),
                    (k[k.length - 1].newStrokeStyle = B),
                    (b.strokeStyle = B),
                    b.setLineDash &&
                      (n[g].lineDashType
                        ? ((y = n[g].lineDashType),
                          (k[k.length - 1].newLineDashArray = Q(
                            y,
                            p.lineThickness
                          )),
                  ...
                  if (
                    0 !== n[g].markerSize &&
                    (0 < n[g].markerSize || 0 < p.markerSize)
                  ) {
                  ...
                  if (
                    ...
                    this._indexLabels.push({
                      ...
                      point: { x: m, y: r },
                      direction:
                        n[g].y[0] > n[g].y[1] === a.axisY.reversed ? -1 : 1,
                      color: C,
                    }),
                      this._indexLabels.push({
                        chartType: "rangeArea",
        ...
        for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
          ...
          if (0 < p.length) {
            ...
            for (g = !1; n < p.length; n++)
              if (
                ((q = p[n].x.getTime ? p[n].x.getTime() : p[n].x),
                !(
                ...
                if (
                  null !== p[n].y &&
                  p[n].y.length &&
                  "number" === typeof p[n].y[0] &&
                  "number" === typeof p[n].y[1]
                ) {
                  ...
                  n < p.length - 1 &&
                    (C !== (p[n].lineColor || x) ||
                      w !== (p[n].lineDashType || h.lineDashType)) &&
                    ((C = p[n].lineColor || x),
                    (r[r.length - 1].newStrokeStyle = C),
                    b.setLineDash &&
                      (p[n].lineDashType
                        ? ((w = p[n].lineDashType),
                          (r[r.length - 1].newLineDashArray = Q(
                        ...
                        : ((w = h.lineDashType),
                          (r[r.length - 1].newLineDashArray = B))));
                  if (
                    0 !== p[n].markerSize &&
                    (0 < p[n].markerSize || 0 < h.markerSize)
                  ) {
                  ...
                  0 < n &&
                    ...
                    (h.connectNullData
                      ? b.setLineDash &&
                        ...
                        (h.options.nullDataLineDashType ||
                          !p[n - 1].lineDashType) &&
                        ((r[r.length - 1].newLineDashArray = y),
                        (w = h.nullDataLineDashType))
                      : (d(B, x), (r = []), (O = []))),
                    (g = !0);
            d(B, x);
            Y.drawMarkers(f);
    ...
    m.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          v.fallingColor = v.options.fallingColor
            ? v.options.fallingColor
            : "#e40a0a";
          var t =
              "number" === typeof v.options.lineThickness
                ? Math.round(v.lineThickness)
                : 1,
            x = 1 === Math.round(t) % 2 ? -0.5 : 0;
          if (0 < O.length)
            for (
              var C = 5 < q && v.bevelEnabled ? !0 : !1,
                w = !1,
                B = null,
                y = null,
                l = 0;
              ...
              if (
                (O[l].getTime ? (p = O[l].x.getTime()) : (p = O[l].x),
                "number" !== typeof O[l].y)
              ) {
                if (0 < l && !w && v.connectNullData)
                  var D =
                    v.options.nullDataLineDashType || !O[l - 1].lineDashType
                      ? v.nullDataLineDashType
                      : O[l - 1].lineDashType;
                w = !0;
              } else {
                k = a.axisX.convertValueToPixel(p);
                m =
                  0 === v.dataPointEOs[l].cumulativeSum
                    ? n
                    : a.axisY.convertValueToPixel(
                        v.dataPointEOs[l].cumulativeSum
                      );
                h =
                  0 === v.dataPointEOs[l].cumulativeSumYStartValue
                    ? n
                    : a.axisY.convertValueToPixel(
                        v.dataPointEOs[l].cumulativeSumYStartValue
                      );
                k = a.axisX.reversed
                  ? (k +
                ...
                var P,
                  K = k;
                P =
                  ("undefined" !== typeof O[l].isIntermediateSum &&
                    !0 === O[l].isIntermediateSum) ||
                  ("undefined" !== typeof O[l].isCumulativeSum &&
                    !0 === O[l].isCumulativeSum)
                    ? 0 < O[l].y
                      ? m
                      : h
                    : 0 < O[l].y
                ...
                0 < l &&
                  B &&
                  (!w || v.connectNullData) &&
                  (w && c.setLineDash && c.setLineDash(Q(D, t)),
                  c.beginPath(),
                  c.moveTo(B, y - x),
                  c.lineTo(K, P - x),
                  0 < t && c.stroke(),
                ...
                K = O[l].lineDashType
                  ? O[l].lineDashType
                  : v.options.lineDashType
                  ? v.options.lineDashType
                  : "shortDash";
                c.strokeStyle = O[l].lineColor
                  ? O[l].lineColor
                  : v.options.lineColor
                  ? v.options.lineColor
                  : "#9e9e9e";
    ...
    m.prototype.renderPie = function (a) {
      function d() {
        if (h && p) {
          for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < p.length; e++) {
            ...
            k = f.indexLabelFormatter
              ? f.indexLabelFormatter(u)
              : f.indexLabel
              ? m.replaceKeywordsWithValue(f.indexLabel, f, h, e)
              : h.indexLabelFormatter
              ? h.indexLabelFormatter(u)
              : h.indexLabel
              ? m.replaceKeywordsWithValue(h.indexLabel, f, h, e)
              : f.label
              ? f.label
              : "";
            m._eventManager.objectMap[l] = n;
            n.center = { x: C.x, y: C.y };
            n.y = f.y;
            n.radius = y;
            n.percentInnerRadius = E;
            n.indexLabelText = k;
            n.indexLabelPlacement = h.indexLabelPlacement;
            n.indexLabelLineColor = f.indexLabelLineColor
          ...
          for (e = 0; e < p.length; e++)
            (n = g[(c + e) % p.length]),
              1 < a &&
                n.midAngle > Math.PI / 2 - t &&
                n.midAngle < Math.PI / 2 + t &&
                (f <= a / 2 && !k
                  ? ((n.hemisphere = "right"), f++)
                  : ((n.hemisphere = "left"), (k = !0)));
          k = !1;
          for (e = 0; e < p.length; e++)
            (n = g[(d + e) % p.length]),
              1 < b &&
      ...
      function c(a) {
        ...
        for (b = 0; b < p.length; b++) {
          ...
          if (d > c) {
            ...
            if (p[b].exploded) {
              if (
                1e-9 < Math.abs(g[b].center.x - (C.x + e)) ||
                1e-9 < Math.abs(g[b].center.y - (C.y + f))
              )
                (g[b].center.x = C.x + e * a),
                  (g[b].center.y = C.y + f * a),
                  (l = !0);
            } else if (
              0 < Math.abs(g[b].center.x - C.x) ||
              0 < Math.abs(g[b].center.y - C.y)
            )
              (g[b].center.x = C.x + e * (1 - a)),
                (g[b].center.y = C.y + f * (1 - a)),
                (l = !0);
            l &&
              ((e = {}),
              (e.dataSeries = h),
            ...
            Z(
              ...
              g[b].center,
              g[b].radius,
              p[b].color ? p[b].color : h._colorSet[b % h._colorSet.length],
              h.type,
              c,
              d,
              h.fillOpacity,
          ...
          (c = g[b]),
            c.indexLabelText &&
              ...
              "inside" !== c.indexLabelPlacement &&
                ...
                ((d = c.center.x + y * Math.cos(c.midAngle)),
                (e = c.center.y + y * Math.sin(c.midAngle)),
                (a.strokeStyle = c.indexLabelLineColor),
                (a.lineWidth = c.indexLabelLineThickness),
                a.setLineDash &&
                  a.setLineDash(
                    Q(c.indexLabelLineDashType, c.indexLabelLineThickness)
                  ),
                a.beginPath(),
                a.moveTo(d, e),
                a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y),
                a.lineTo(
                  c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -n : n),
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < p.length) {
          var m = g[a];
          if (
            (0 > c && m.indexLabelTextBlock.y < l) ||
            (0 < c && m.indexLabelTextBlock.y > n)
          )
            return 0;
          var k = 0,
            q = 0,
            q = (k = k = 0);
          0 > c
            ? m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 > l &&
              m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 + c <
                l &&
              (c = -(
                l -
                (m.indexLabelTextBlock.y - m.indexLabelTextBlock.height / 2 + c)
          ...
          l =
            "right" === m.hemisphere
              ? C.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - C.y, 2))
              : C.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - C.y, 2));
            ...
            ? ((n = "right" === m.hemisphere ? q : k),
              ...
              null !== n &&
                ...
                c - q < A &&
                  ((l = -q),
                  (n = f(n, l, d + 1)),
                  +n.toFixed(x) > +l.toFixed(x) &&
                    (h = c > A ? -(c - A) : -(q - (n - l))))))
            : 0 < c &&
              ((n = "right" === m.hemisphere ? k : q),
              (h = c),
              null !== n &&
                ((q = c),
                (c =
                  g[n].indexLabelTextBlock.y -
                  g[n].indexLabelTextBlock.height / 2 -
                  (m.indexLabelTextBlock.y + m.indexLabelTextBlock.height / 2)),
                c - q < A &&
                  ((l = q),
                  (n = f(n, l, d + 1)),
                  +n.toFixed(x) < +l.toFixed(x) &&
                    (h = c > A ? c - A : q - (l - n)))));
          h &&
            ((d = m.indexLabelTextBlock.y + h),
            (c = 0),
            (c =
              "right" === m.hemisphere
                ? C.x + Math.sqrt(Math.pow(s, 2) - Math.pow(d - C.y, 2))
                : C.x - Math.sqrt(Math.pow(s, 2) - Math.pow(d - C.y, 2))),
            m.midAngle > Math.PI / 2 - t && m.midAngle < Math.PI / 2 + t
              ...
              : m.midAngle > (3 * Math.PI) / 2 - t &&
                ...
                c < l.indexLabelTextBlock.x
                  ...
                  : "left" === m.hemisphere &&
                    ...
                    c > a.indexLabelTextBlock.x &&
                    (c = a.indexLabelTextBlock.x - 15)),
            (m.indexLabelTextBlock.y = d),
            (m.indexLabelTextBlock.x = c),
            (m.indexLabelAngle = Math.atan2(
              m.indexLabelTextBlock.y - C.y,
              m.indexLabelTextBlock.x - C.x
            )));
        }
        return h;
      }
      function l() {
        ...
        for (
          ...
          if ("inside" !== h.indexLabelPlacement) {
            ...
            for (var u, t, a = 0; a < p.length; a++) {
              ...
              if (null !== r) {
                ...
                var B = 0,
                  B = b(u, t) - A;
                if (0 > B) {
                  for (var w = (t = 0), J = 0; J < p.length; J++)
                    J !== a &&
                      g[J].hemisphere === k.hemisphere &&
                      (g[J].indexLabelTextBlock.y < k.indexLabelTextBlock.y
                        ? t++
                        : w++);
                  t = (B / (t + w || 1)) * w;
                  var w = -1 * (B - t),
                  ...
                  "right" === k.hemisphere
                    ? ((J = f(a, t)),
                      (w = -1 * (B - J)),
                      (I = f(r, w)),
                      +I.toFixed(x) < +w.toFixed(x) &&
                        +J.toFixed(x) <= +t.toFixed(x) &&
                        f(a, -(w - I)))
                    : ((J = f(r, t)),
                      (w = -1 * (B - J)),
                      (I = f(a, w)),
            ...
            for (a = 0; a < p.length; a++)
              (k = g[a]),
                (s = "pie" === h.type ? 0.7 * y : 0.8 * y),
                (r = C.x + s * Math.cos(k.midAngle)),
                (t = C.y + s * Math.sin(k.midAngle)),
                (k.indexLabelTextBlock.x = r),
                (k.indexLabelTextBlock.y = t);
          for (a = 0; a < p.length; a++)
            if (
              ((k = g[a]),
              (r = k.indexLabelTextBlock.measureText()),
              0 !== r.height && 0 !== r.width)
            )
              (r = r = 0),
                "right" === k.hemisphere
                  ? ((r =
                      q.x2 -
                      (k.indexLabelTextBlock.x +
                        k.indexLabelTextBlock.width +
                        n)),
                    (r *= -1))
                  : (r =
                      q.x1 -
                ...
                0 < r &&
                  (!l &&
                    ...
                    ((t =
                      "right" === k.hemisphere
                        ? q.x2 - k.indexLabelTextBlock.x
                        : k.indexLabelTextBlock.x - q.x1),
                    0.3 * k.indexLabelTextBlock.maxWidth > t
                      ? (k.indexLabelText = "")
                      : (k.indexLabelTextBlock.maxWidth = 0.85 * t),
                    0.3 * k.indexLabelTextBlock.maxWidth < t &&
                      (k.indexLabelTextBlock.x -=
                        "right" === k.hemisphere ? 2 : -2)),
                  Math.abs(
                  ...
                  ((r /= Math.abs(Math.cos(k.indexLabelAngle))),
                  9 < r && (r *= 0.3),
                  r > d && (d = r)),
                (r = r = 0),
                  ...
                  (!l &&
                    ...
                    ((t =
                      0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, r * t) && f(a, 2 * t)),
                  Math.abs(k.indexLabelTextBlock.x - C.x) < y &&
                    ((r /= Math.abs(Math.sin(k.indexLabelAngle))),
                    9 < r && (r *= 0.3),
                    r > d && (d = r)));
              ...
              if (((f = !1), (u = g[h]), u.indexLabelText)) {
                ...
                if (null !== l) {
                  ...
                  m
                    ? (0 > a && (a = h),
                      l !== a && ((c = l), (d += -B)),
                      0 === h % Math.max(p.length / 10, 3) && (f = !0))
                    : (f = !0);
                  f &&
                    0 < d &&
                    0 <= a &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        var h = this.data[a.dataSeriesIndexes[0]],
          ...
          t = (20 / 180) * Math.PI,
          x = 6,
          C = { x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2 },
          w = 0;
        a = !1;
        for (var B = 0; B < p.length; B++)
          (w += Math.abs(p[B].y)),
            !a &&
              "undefined" !== typeof p[B].indexLabel &&
              null !== p[B].indexLabel &&
              0 < p[B].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof p[B].label &&
              null !== p[B].label &&
              0 < p[B].label.toString().length &&
              (a = !0);
        if (0 !== w) {
          a =
            a ||
    ...
    m.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        if (0 === g) return -1;
        for (
          var l = (d[0] = 0), k = 0, n, m, b = b - a, l = !1, h = 0;
          h < x.length;
          h++
        )
        ...
        if (t && x) {
          ...
          for (var y = 0, B = x.length - 1; y < x.length || 0 <= B; y++, B--) {
            ...
            a = b.color
              ? b.color
              : t.reversed
              ? t._colorSet[(x.length - 1 - y) % t._colorSet.length]
            ...
            b = b.indexLabelFormatter
              ...
              : b.indexLabel
              ? w.replaceKeywordsWithValue(b.indexLabel, b, t, y)
              : t.indexLabelFormatter
              ? t.indexLabelFormatter(C)
              : t.indexLabel
              ? w.replaceKeywordsWithValue(t.indexLabel, b, t, y)
              : b.label
              ? b.label
              : "";
            0 >= n && (n = 0);
      ...
      function e() {
        ...
        for (
          var g,
            h = N - aa - W / 2,
            h = t.options.indexLabelMaxWidth
              ? t.indexLabelMaxWidth > h
                ? h
                : t.indexLabelMaxWidth
              : h,
            l = H.length - 1;
        ...
        if (e)
          for (l = H.length - 1; 0 <= l; l--)
            (a = R[l]),
              ...
              t.reversed
                ? (H[l].textBlock.y + H[l].height > U + D &&
                    (H[l].textBlock.y = U + D - H[l].height),
                  H[l].textBlock.y < sa - D && (H[l].textBlock.y = sa - D))
                : (H[l].textBlock.y < U - D && (H[l].textBlock.y = U - D),
                  H[l].textBlock.y + H[l].height > sa + D &&
                    (H[l].textBlock.y = sa + D - H[l].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < R.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = R[e]),
                ...
                t.reversed
                  ? (H[e].textBlock.y + H[e].height > U + D &&
                      (H[e].textBlock.y = U + D - H[e].height),
                    H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D))
                  : (H[e].textBlock.y < U - D && (H[e].textBlock.y = U - D),
      ...
      function l() {
        ...
        function b() {
          ...
          for (var l, k = 1; k < h; k++) {
            ...
            for (var p = H.length - 1; 0 <= p; p--)
              !H[p].isDirty &&
                H[p].textBlock.y < e &&
                H[p].textBlock.y + H[p].height > e &&
                ((l = q(p)),
                !(l >= H.length - 1) &&
                  H[p].textBlock.y + H[p].height + ea > H[l].textBlock.y &&
                  (H[p].textBlock.y =
                    H[p].textBlock.y + H[p].height - e > e - H[p].textBlock.y
                      ? e + 1
                      : e - H[p].height - 1));
          }
        ...
        for (var d, e, f, g, h, l, m = 1, p = 0; p < 2 * m; p++) {
          for (
            ...
            (f = H[t]),
            (g = f.textBlock),
            (l = (h = q(t) < R.length ? H[q(t)] : null) ? h.textBlock : null),
            (d = +f.height.toFixed(6)),
            (e = +g.y.toFixed(6)),
            !f.isDirty &&
              h &&
              e + d + ea > +l.y.toFixed(6) &&
              ((d = g.y + d + ea - l.y),
              (e = a(t, -d)),
              e < d && (0 < e && (d -= e), (e = a(q(t), d)), e != d)));
            t--
          );
          b();
        }
      ...
      function k(a, b) {
        return (
          (b < R.length ? H[b].textBlock.y : t.reversed ? U + D : sa + D) -
          (0 > a
            ? t.reversed
              ? sa - D
              : U - D
        ...
        for (var b, c, d, e, f = 0; f < R.length; f++)
          (e = 1 === H[f].lineThickness % 2 ? 0.5 : 0),
            ...
            H[f].isDirty ||
              ...
              a.setLineDash &&
                a.setLineDash(Q(H[f].lineDashType, H[f].lineThickness)),
              a.beginPath(),
              a.moveTo(b, c),
              a.lineTo(d, e),
              a.stroke());
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var t = this.data[a.dataSeriesIndexes[0]],
            ...
            y = 0,
            E = C.height - 2 * D,
            G = Math.min(C.width - 2 * B, 2.8 * C.height),
            K = !1,
            P = 0;
          P < x.length;
          P++
          ...
          if (
            (!K &&
              "undefined" !== typeof x[P].indexLabel &&
              null !== x[P].indexLabel &&
              0 < x[P].indexLabel.toString().length &&
              (K = !0),
            !K &&
              "undefined" !== typeof x[P].label &&
              null !== x[P].label &&
              0 < x[P].label.toString().length &&
              (K = !0),
            (!K && "function" === typeof t.indexLabelFormatter) ||
              "function" === typeof x[P].indexLabelFormatter)
          )
            K = !0;
        K =
          K ||
        ...
        ("inside" !== t.indexLabelPlacement && K) ||
          (B = (C.width - 0.75 * G) / 2);
        var P = C.x1 + B,
          N = C.x2 - B,
          $ = C.y1 + D,
        ...
        if (0 != t.length && t.dataPoints && t.visible && 0 !== x.length) {
          ...
          var W = (30 * (N - a)) / 100;
          "funnel" === t.type
            ? ((ca = r(t.options.neckHeight) ? 0.35 * E : t.neckHeight),
              (F = r(t.options.neckWidth) ? 0.25 * a : t.neckWidth),
              "string" === typeof ca && ca.match(/%$/)
                ? ((ca = parseInt(ca)), (ca = (ca * E) / 100))
                : (ca = parseInt(ca)),
              ...
              F > a ? (F = a - 0.5) : 0 >= F && (F = 0))
            : "pyramid" === t.type &&
              ((F = ca = 0), (t.reversed = t.reversed ? !1 : !0));
          var B = P + a / 2,
            X = P,
            aa = P + a,
            U = t.reversed ? T : $,
          ...
          if (-1 !== P) {
            if (t.reversed)
              for (G.push(V), F = P.length - 1; 0 < F; F--)
                (V += P[F]), G.push(V);
            else for (F = 0; F < P.length; F++) (V += P[F]), G.push(V);
            if (t.reversed)
              for (F = 0; F < P.length; F++)
                G[F] < xa
                  ? (a.push(M), B.push(Y), (da = F))
                  : (a.push((G[F] - U + ba * X) / ba),
                    B.push((G[F] - U + fa * aa) / fa));
            else
              for (F = 0; F < P.length; F++)
                G[F] < xa
                  ? (a.push((G[F] - U + ba * X) / ba),
            ...
            for (F = 0; F < P.length - 1; F++)
              (V = t.reversed
                ? x[x.length - 1 - F].color
                  ? x[x.length - 1 - F].color
                  : t._colorSet[(x.length - 1 - F) % t._colorSet.length]
                : x[F].color
                ? x[F].color
            ...
            for (F = 0; F < x.length; F++)
              x[F].exploded &&
                ((P = !0), t.reversed ? Z.push(x.length - 1 - F) : Z.push(F));
            S.clearRect(C.x1, C.y1, C.width, C.height);
            ...
            if (
              ...
              for (F = 0; F < R.length; F++)
                (R[F].x1 += y),
                  ...
                  (R[F].x3 += y),
                  (R[F].x4 += y),
                  R[F].x5 && ((R[F].x5 += y), (R[F].x6 += y)),
                  (H[F].textBlock.x += y);
            }
            for (F = 0; F < R.length; F++)
              (y = R[F]), qa(S, y, t.fillOpacity), ja.push(y.y1);
            v(S);
            K &&
              t.visible &&
              ("inside" === t.indexLabelPlacement || w.animationEnabled || p(S),
              w.animationEnabled || A());
            if (!K)
              for (F = 0; F < x.length; F++)
                (y = t.dataPointIds[F]),
                  (a = {
            ...
            !w.animationEnabled && P
              ? m(w, -1, 0)
              : w.animationEnabled && !w.animatedRender && m(w, -1, 0);
            ...
            var q = (n.legendMarkerType = n.legendMarkerType
                ...
                ? "error" === n.type && n._linkedSeries
                  ? n._linkedSeries.legendMarkerType
                    ? n._linkedSeries.legendMarkerType
                    : G.getDefaultLegendMarker(n._linkedSeries.type)
                  : G.getDefaultLegendMarker(n.type)
                : n.markerType),
              g = n.legendText
                ? n.legendText
                ...
                : n.name,
              A = (n.legendMarkerColor = n.legendMarkerColor
                ? n.legendMarkerColor
                : n.markerColor
                ? n.markerColor
                : "error" === n.type
            ...
            for (var x = 0; x < n.dataPoints.length; x++) {
              var w = n.dataPoints[x],
                ...
                A = w.legendMarkerColor
                  ...
                  : n.color
                  ? n.color
                  : n._colorSet[x % n._colorSet.length],
                s = 0.75 * this.lineHeight,
                v = w.legendMarkerBorderColor
                  ? w.legendMarkerBorderColor
                  : n.legendMarkerBorderColor
                  ? n.legendMarkerBorderColor
                  : w.markerBorderColor
                  ? w.markerBorderColor
                ...
                t = w.legendMarkerBorderThickness
                  ? w.legendMarkerBorderThickness
                  : n.legendMarkerBorderThickness
                  ? n.legendMarkerBorderThickness
                  : w.markerBorderThickness || n.markerBorderThickness
                  ? Math.max(1, Math.round(0.2 * s))
                  : 0,
              ...
              (w.showInLegend || (n.showInLegend && !1 !== w.showInLegend)) &&
                m.push(q);
            }
      }
            ...
            if ("horizontal" === this.orientation) {
              ...
              (q.textBlock = new la(this.ctx, {
                ...
                this.height < l - this.lineHeight
                  ? ((n = { items: [], width: 0 }), h.push(n))
                  : ((n = h[x]), (x = (x + 1) % h.length)),
    ...
    E.prototype.render = function () {
      ...
      for (var k = 0, m = 0; m < l.length; m++) {
        for (var h = l[m], p = 0, n = 0; n < h.items.length; n++) {
          var q = h.items[n],
            g =
              q.textBlock.x + a + (0 === n ? 0.2 * f : this.horizontalSpacing),
            r = d + k,
            s = g;
        ...
        if (0 <= f && f < this.dataPoints.length) {
          var b = this.dataPoints[f],
            n = this.axisX.logarithmic
              ...
              : Math.abs(b.x - a);
          n < c.distance &&
            ((c.dataPoint = b), (c.distance = n), (c.index = f));
          b = n;
          b <= k ? (k = b) : 0 < l ? m++ : h++;
            ...
            if (((c = this.logLabelValues[b]), c < this.viewportMinimum)) b++;
              ...
              a ||
                ((a = this.labelFormatter
                  ...
                  ? this.labels[p]
                  : fa(p, this.valueFormatString, this.chart._cultureInfo)),
                (a = new la(this.ctx, {
                  x: 0,
                  y: 0,
                  maxWidth: f,
        ...
        for (
          ...
          a ||
            ((a = this.labelFormatter
              ...
              : "axisX" === this.type && this.labels[p]
              ? this.labels[p]
              : Aa(p, this.valueFormatString, this.chart._cultureInfo)),
            (a = new la(this.ctx, {
              x: 0,
              y: 0,
              maxWidth: f,
                  ...
                  (p =
                    0 != this.labelAngle
                      ? (h -
                        ...
                        Math.sin((Math.PI / 180) * Math.abs(this.labelAngle))
                      : f),
                  (this.sessionVariables.labelMaxHeight = l = this.labelWrap
                    ? (h -
                        p *
                          Math.sin(
                            (Math.PI / 180) * Math.abs(this.labelAngle)
        ...
        if ("outside" === f.labelPlacement) {
          ...
          if ("bottom" === this._position || "top" === this._position)
            ...
            !r(this.sessionVariables.stripLineLabelMaxHeight)
              ...
              : (this.sessionVariables.stripLineLabelMaxHeight = w = f.labelWrap
                  ? (0.8 * this.chart.height) >> 0
                  : 1.5 * this.labelFontSize);
          ...
          (l =
            ...
            r(f.labelBackgroundColor) &&
              (r(f.startValue) && 0 !== f.startValue
                ? (f.labelBackgroundColor = s ? "transparent" : null)
    ...
    D.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++)
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (
            var A = q[g].scaleBreaks._appliedBreaks, s = 0;
            s < A.length && !(A[s].startValue > q[g].viewportMaximum);
            s++
          )
            A[s].endValue < q[g].viewportMinimum ||
              (r(q[g].scaleBreaks.firstBreakIndex) &&
                (q[g].scaleBreaks.firstBreakIndex = s),
              A[s].startValue >= q[g].viewPortMinimum &&
                (q[g].scaleBreaks.lastBreakIndex = s));
      for (
        var v = (s = 0),
          t = 0,
          x = 0,
        ...
        q[g] &&
          q[g].title &&
          (q[g]._titleTextBlock = new la(q[g].ctx, {
            text: q[g].title,
            horizontalAlign: "center",
      ...
      if ("normal" === e) {
        for (
          ...
          m = Math.round(
            f.x2 - ba - aa > p.width - n ? p.width - n : f.x2 - ba - aa
          );
          if (a && 0 < a.length)
            for (x = [], g = V = 0; g < a.length; g++)
          ...
          if (d && 0 < d.length)
            for (w = [], g = Y = 0; g < d.length; g++)
              d[g] && (d[g].lineCoordinates = {}),
                ...
                (Y += w[g]),
                (Z += d[g] && !p.isNavigator ? d[g].margin : 0);
          else
            w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
          Q.push(w);
          if (a && 0 < a.length)
              ...
              a[g] &&
                ...
                a[g]._labels &&
                  ...
                  (v =
                    ...
                    (h.textBlock.height - k.textBlock.fontSize / 2) *
                ...
                !a[g] ||
                  ...
                  0 < a[g].labelAngle
                    ? E + t > m &&
                      (k += 0 < a[g].labelAngle ? E + t - m - ba : 0)
                    : 0 > a[g].labelAngle
                    ? y - v < l &&
                      y - v < a[g].viewportMinimum &&
                      (G =
                        l -
                        (M +
                          a[g].tickLength +
                  ...
                  0 < k
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < G && (l += G), 0 < k && (m -= k))),
                p.panEnabled
                  ? (V = r(p.sessionVariables.axisX.height)
                      ? (p.sessionVariables.axisX.height = V)
                      : p.sessionVariables.axisX.height)
                  : (p.sessionVariables.axisX.height = V),
                (k = Math.round(f.y2 - V - e + F)),
                (h = Math.round(f.y2)),
                (a[g].lineCoordinates.x2 = m),
                (a[g].lineCoordinates.width = m - l),
                (a[g].lineCoordinates.y1 = k),
                (a[g].lineCoordinates.y2 = k + a[g].lineThickness / 2),
          ...
          if (d && 0 < d.length)
            for (g = 0; g < d.length; g++)
              (d[g].lineCoordinates.x1 = Math.round(f.x1 + R + M)),
                ...
                d[g]._labels &&
                  ...
                  (t =
                    ...
                    (k.textBlock.height - k.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle)))),
                p.panEnabled
                  ? (Y = r(p.sessionVariables.axisX2.height)
                      ? (p.sessionVariables.axisX2.height = Y)
                      : p.sessionVariables.axisX2.height)
                  : (p.sessionVariables.axisX2.height = Y),
                (k = Math.round(f.y1)),
                (h = Math.round(f.y2 + d[g].margin)),
                (d[g].lineCoordinates.y1 = k + Y + Z - W),
                (d[g].lineCoordinates.y2 = k),
              ...
              b[g] &&
                ...
                (M =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (k = Math.round(
                  f.y1 + Y + Z < Math.max(M, n) ? Math.max(M, n) : f.y1 + Y + Z
                )),
                (M =
                  0 < a.length
                    ? 0
        ...
        for (Q = []; 4 > s; ) {
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (m = Math.round(
                  f.x2 - V - Z > p.width - 10 ? p.width - 10 : f.x2 - V - Z
                )),
                c[g].labelAutoFit &&
                  !r(x) &&
                  (0 < !a.length &&
          ...
          if (b && 0 < b.length)
            ...
            y.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
          t.push(y);
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              0 < c[g]._labels.length &&
                ((h = c[g]._labels[0]),
                (k = c[g]._labels[c[g]._labels.length - 1]),
                (x =
                  h.textBlock.width *
                    Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) +
                  (h.textBlock.height - k.textBlock.fontSize / 2) *
          ...
          if (b && 0 < b.length)
            for (g = 0; g < b.length; g++)
              b[g] &&
                ...
                ((h = b[g]._labels[0]),
                (k = b[g]._labels[b[g]._labels.length - 1]),
                (D =
                  h.textBlock.width *
                    Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) +
                  (h.textBlock.height - k.textBlock.fontSize / 2) *
          ...
          if (p.panEnabled)
            for (g = 0; g < c.length; g++)
              n[g] = r(p.sessionVariables.axisY.height)
                ? (p.sessionVariables.axisY.height = n[g])
                : p.sessionVariables.axisY.height;
          else
            for (g = 0; g < c.length; g++)
              p.sessionVariables.axisY.height = n[g];
          if (c && 0 < c.length)
            for (g = c.length - 1; 0 <= g; g--)
              (k = Math.round(f.y2)),
                ...
                (c[g].lineCoordinates.y1 = k - (n[g] + c[g].margin + Y)),
                (c[g].lineCoordinates.y2 = k - (n[g] + c[g].margin + Y)),
                "inside" === c[g].labelPlacement &&
                  0 < g &&
          ...
          if (b && 0 < b.length)
            for (g = b.length - 1; 0 <= g; g--)
              b[g] &&
                ((k = Math.round(f.y1)),
                (h = Math.round(f.y1 + (y[g] + b[g].margin + F))),
                ...
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ...
                        : f.y2 - U > p.height - Math.max(M, 10)
                        ? p.height - Math.max(M, 10)
                        : f.y2 - U
                    )
                  : f.y2 > p.height - Math.max(M, 10)
                  ? p.height - Math.max(M, 10)
                  : f.y2;
              if (c && 0 < c.length)
                  ...
                  c[M] &&
                    ...
                    ((m =
                      0 > c[M].labelAngle
                        ...
                        : m),
                    (l =
                      0 > c[M].labelAngle || 0 === c[M].labelAngle
                        ? m - X
                        : l));
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] &&
                    b[M].labelAutoFit &&
                    ((m = b[M].lineCoordinates.x1), (l = m - X));
              a[g].lineCoordinates = {
                x1: m - S,
                y1: k,
                x2: m - S,
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] &&
                    b[M].labelAutoFit &&
                    ((m = b[M].lineCoordinates.x2), (l = m - V));
              d[g].lineCoordinates = {
                x1: m + T,
                y1: k,
                x2: m + T,
    ...
    D.render = function (a, d, c, b, e) {
      ...
      if (d && 0 < d.length)
        for (l = 0; l < d.length; l++)
          d[l].renderGrid(),
            s && (d[l].createMask(), d[l].renderBreaksBackground());
      if (c && 0 < c.length)
        for (l = 0; l < c.length; l++)
          c[l].renderGrid(),
            s && (c[l].createMask(), c[l].renderBreaksBackground());
      if (b && 0 < b.length)
        for (l = 0; l < b.length; l++)
          b[l].renderGrid(),
            s && (b[l].createMask(), b[l].renderBreaksBackground());
      if (a && 0 < a.length)
                        ...
                        ? 0 < this.labelAngle
                          ...
                          : q.x -
                            n.textBlock.width *
                              Math.cos((Math.PI / 180) * this.labelAngle)
                        : q.x +
                          (n.textBlock.height - this.labelFontSize) *
                            Math.sin((Math.PI / 180) * this.labelAngle) -
                          (0 < this.labelAngle
                            ? n.textBlock.width *
                              Math.cos((Math.PI / 180) * this.labelAngle)
                    ...
                    (n.textBlock.x =
                      "inside" === this.labelPlacement
                        ...
                        : q.x -
                          n.textBlock.width *
                            Math.cos((Math.PI / 180) * this.labelAngle) +
                          (n.textBlock.height - n.textBlock.fontSize / 2 - 5) *
                            Math.sin((Math.PI / 180) * this.labelAngle) -
                          ("inside" === this.tickPlacement
                            ? 0
                            : this.tickLength)))));
          ...
          h._thicknessType === a &&
            (("pixel" === a &&
              (h.value < this.viewportMinimum ||
                ...
                isNaN(this.range))) ||
              ("value" === a &&
                ((h.startValue <= this.viewportMinimum &&
                  h.endValue <= this.viewportMinimum) ||
                  (h.startValue >= this.viewportMaximum &&
                    h.endValue >= this.viewportMaximum) ||
                  r(h.startValue) ||
                  r(h.endValue) ||
                  isNaN(this.range))) ||
              k.push(h));
    ...
    D.prototype.renderGrid = function () {
      if (this.gridThickness && 0 < this.gridThickness) {
        ...
        a.setLineDash &&
          a.setLineDash(Q(this.gridDashType, this.gridThickness));
        if ("bottom" === this._position || "top" === this._position)
          for (b = 0; b < this._labels.length; b++)
    ...
    D.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          d.setLineDash &&
            d.setLineDash(Q(this.lineDashType, this.lineThickness));
          var l =
          ...
          if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
            if (r(this.scaleBreaks.lastBreakIndex))
              ...
              for (
                ...
                d.moveTo(e, l),
                  d.lineTo(
                    this.scaleBreaks._appliedBreaks[k].startPixel + c,
                    l
                  ),
        ...
        if (this.scaleBreaks && !r(this.scaleBreaks.firstBreakIndex))
          if (r(this.scaleBreaks.lastBreakIndex))
            ...
            for (
              k = this.scaleBreaks.firstBreakIndex;
              k <= this.scaleBreaks.lastBreakIndex;
              k++
            )
              d.moveTo(l, e),
                d.lineTo(l, this.scaleBreaks._appliedBreaks[k].startPixel + b),
            ...
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * T.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(
                        D.getNiceNumber(b / (a - 1), !0) / T.yearDuration
                      )),
    ...
    D.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      l = Math.pow(
        this.logarithmBase,
        D.getNiceNumber(Math.abs(Math.log(l) / d), !1)
      );
      this.options && 0 < this.options.interval
        ? (this.interval = this.options.interval)
        : ((this.interval = D.getNiceExponent(Math.log(l) / d / (a - 1), !0)),
          (c = D.getNiceNumber(k / (a - 1), !0)));
      if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
        this.viewportMinimum =
          "axisX" === this.type
            ? b / Math.sqrt(f)
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            (l = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0),
            "top" === this.scaleBreaks.parent._position
              ? ((e = this.chart.plotArea.y1),
                (k = (this.chart.plotArea.y2 + n / 2 + 0.5) << 0))
              : ((e = this.chart.plotArea.y2),
                (k = (this.chart.plotArea.y1 - n / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b - n / 2, y1: e, x2: l + n / 2, y2: k }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("top" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("bottom" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(b, k), this.ctx.lineTo(l, k), this.ctx.lineTo(l, e);
          ...
          if (
            ...
            (k = 1 === n % 2 ? (b.y << 0) + 0.5 : b.y << 0),
            "left" === this.scaleBreaks.parent._position
              ? ((b = this.chart.plotArea.x1),
                (l = (this.chart.plotArea.x2 + n / 2 + 0.5) << 0))
              : ((b = this.chart.plotArea.x2),
                (l = (this.chart.plotArea.x1 - n / 2 + 0.5) << 0),
                (a *= -1)),
            (this.bounds = { x1: b, y1: e - n / 2, x2: l, y2: k + n / 2 }),
            this.ctx.moveTo(b, e),
            "straight" === this.type ||
              ("left" === this.scaleBreaks.parent._position && 0 >= a) ||
              ("right" === this.scaleBreaks.parent._position && 0 <= a))
          )
            this.ctx.lineTo(l, e), this.ctx.lineTo(l, k), this.ctx.lineTo(b, k);
          else if ("wavy" === this.type) {
            m = b;
            h = e;
            f = 0.5;
            ...
            p = (l - m) / a / 2;
            for (q = 0; q < p; q++)
              this.ctx.lineTo(m, h), (h += 2 * f * a), (m += 2 * a), (f *= -1);
            this.ctx.lineTo(m, h);
            h += k - e;
            for (q = 0; q < p + 1; q++)
              this.ctx.lineTo(m, h), (h += 2 * f * a), (m -= 2 * a), (f *= -1);
      ...
      if (0 < d) {
        ...
        if (
          ...
          (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0),
            (l = this.chart.plotArea.y1),
            (k = this.chart.plotArea.y2),
            (this.bounds = { x1: e - d / 2, y1: l, x2: f + d / 2, y2: k });
        else if (
          "left" === this.parent._position ||
          "right" === this.parent._position
        )
          (l = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0),
            (e = this.chart.plotArea.x1),
            (f = this.chart.plotArea.x2),
            (this.bounds = { x1: e, y1: l - d / 2, x2: f, y2: k + d / 2 });
        this.ctx.moveTo(e, l);
        this.ctx.lineTo(f, k);
        this.ctx.stroke();
    ...
    ba.prototype.render = function (a, d, c) {
      ...
      q.lineWidth = n;
      q.save();
      this.labelFontSize = r(this.options.labelFontSize)
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var w = 0; w < this.parent.dataSeries.length; w++)
            (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) &&
              0 <= v.index &&
              ((v.dataSeries = this.parent.dataSeries[w]),
              null !== v.dataPoint.y && v.dataSeries.visible && p.push(v));
          v = null;
          ...
          w = 0;
          if (
            "rangeBar" === p[0].dataSeries.type ||
            "error" === p[0].dataSeries.type
          )
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(p[w].dataPoint.y[0])
                ),
                t = 0,
                s = 0;
              s < p.length;
              ...
              if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                for (var x = 0; x < p[s].dataPoint.y.length; x++)
                  (t = Math.abs(
                    a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])
                  )),
                    t < v && ((v = t), (w = s));
              else
                (t = Math.abs(
                  a - this.parent.convertValueToPixel(p[s].dataPoint.y)
                )),
                  t < v && ((v = t), (w = s));
          else if ("stackedBar" === p[0].dataSeries.type)
            for (
              var v = Math.abs(
                  a - this.parent.convertValueToPixel(p[0].dataPoint.y)
                ),
                C = (t = 0),
                s = (w = 0);
              s < p.length;
              ...
              if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                for (x = 0; x < p[s].dataPoint.y.length; x++)
                  (t = Math.abs(
                    a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])
                  )),
                    t < v && ((v = t), (w = s));
                ...
                (C += p[s].dataPoint.y),
                  (t = Math.abs(a - this.parent.convertValueToPixel(C))),
                  t < v && ((v = t), (w = s));
            ...
            for (
              ...
              if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                ...
                (C += p[s].dataPoint.y),
                  (E = p[s].dataPoint.x.getTime
                    ? p[s].dataPoint.x.getTime()
                    : p[s].dataPoint.x),
                  (E = 100 * (C / p[s].dataSeries.plotUnit.dataPointYSums[E])),
                  (t = Math.abs(a - this.parent.convertValueToPixel(E))),
                  t < v && ((v = t), (w = s));
          else
            for (
              v = Math.abs(
          ...
          if (
            ...
            if (
              ...
              for (s = t = 0; s < x.dataPoint.y.length; s++)
                (t = Math.abs(
                  a - this.parent.convertValueToPixel(x.dataPoint.y[s])
                )),
                  t < v && ((v = t), (b = s));
              k =
                1 === q.lineWidth % 2
              ...
              h.text = this.labelFormatter
                ...
                : r(this.options.label)
                ? fa(c ? c : E, this.valueFormatString, this.chart._cultureInfo)
                : this.label;
            } else
              (k =
                1 === q.lineWidth % 2
            ...
            h.y =
              ...
              ("top" === this.parent._position
                ? -h.height + this.parent.tickLength
                : h.fontSize / 2) +
              2;
            ...
            if (this.parent.labels)
              for (
                p = Math.ceil(this.parent.interval), s = 0;
          ...
          if (E) {
            if ("axisX" === this.parent.type)
              for (
                s = this.parent.convertPixelToValue({ x: a }), v = null, w = 0;
                w < this.parent.dataSeries.length;
                w++
              )
                (v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) &&
          ...
          w = 0;
          if (
            "rangeColumn" === p[0].dataSeries.type ||
            "rangeArea" === p[0].dataSeries.type ||
            "error" === p[0].dataSeries.type ||
            "rangeSplineArea" === p[0].dataSeries.type ||
            "candlestick" === p[0].dataSeries.type ||
            "ohlc" === p[0].dataSeries.type ||
            "boxAndWhisker" === p[0].dataSeries.type
          )
            for (
              v = Math.abs(
                d - this.parent.convertValueToPixel(p[0].dataPoint.y[0])
              ),
                s = t = 0;
              s < p.length;
              s++
              ...
              if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                for (x = 0; x < p[s].dataPoint.y.length; x++)
                  (t = Math.abs(
                    d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])
                  )),
                    t < v && ((v = t), (w = s));
              else
                (t = Math.abs(
                  d - this.parent.convertValueToPixel(p[s].dataPoint.y)
                )),
                  t < v && ((v = t), (w = s));
          else if (
            "stackedColumn" === p[0].dataSeries.type ||
            "stackedArea" === p[0].dataSeries.type
          )
            for (
              v = Math.abs(
                d - this.parent.convertValueToPixel(p[0].dataPoint.y)
              ),
                s = C = t = 0;
              s < p.length;
              s++
              ...
              if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                ...
                (C += p[s].dataPoint.y),
                  (t = Math.abs(d - this.parent.convertValueToPixel(C))),
                  t < v && ((v = t), (w = s));
          else if (
            "stackedColumn100" === p[0].dataSeries.type ||
            "stackedArea100" === p[0].dataSeries.type
          )
            for (
              v = Math.abs(
                d - this.parent.convertValueToPixel(p[0].dataPoint.y)
              ...
              if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                ...
                (C += p[s].dataPoint.y),
                  (E = p[s].dataPoint.x.getTime
                    ...
                    : p[s].dataPoint.x),
                  (E = 100 * (C / p[s].dataSeries.plotUnit.dataPointYSums[E])),
                  (t = Math.abs(d - this.parent.convertValueToPixel(E))),
                  t < v && ((v = t), (w = s));
          else
            for (
              v = Math.abs(
          ...
          if (
            ...
            for (s = t = 0; s < x.dataPoint.y.length; s++)
              (t = Math.abs(
                d - this.parent.convertValueToPixel(x.dataPoint.y[s])
              )),
                t < v && ((v = t), (b = s));
            m =
              1 === q.lineWidth % 2
        ...
        if (
          ...
          (b = e = k = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0),
            (f = this.chart.plotArea.y1),
            (l = this.chart.plotArea.y2),
            (this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: l });
        else if (
          ...
          (f = l = m = 1 === q.lineWidth % 2 ? (d << 0) + 0.5 : d << 0),
            (b = this.chart.plotArea.x1),
            (e = this.chart.plotArea.x2),
            (this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: l + n / 2 });
        if ("xySwapped" === this.chart.plotInfo.axisPlacement)
        ...
        "left" === this.parent._position && h.x < this.chart.bounds.x1
          ...
          : "bottom" === this.parent._position &&
            ...
            (h.y = this.chart.bounds.y2 - h.height + h.fontSize / 2 + 2);
        0 < n &&
          (q.moveTo(b, f), q.lineTo(e, l), q.stroke(), (this._hidden = !1));
        q.restore();
        !r(h.text) &&
          ("number" === typeof h.text.valueOf() || 0 < h.text.length) &&
          h.render(!0);
      ...
      if ("bottom" === this.parent._position || "top" === this.parent._position)
        this._updatedValue = this.parent.convertPixelToValue(k);
    ...
    aa.prototype._updateToolTip = function (a, d, c) {
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (
          ...
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX)
              for (var m = 0; m < this.chart.axisX.length; m++) {
                for (
                  var l = this.chart.axisX[m].convertPixelToValue({ y: d }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX[m].dataSeries.length;
                  b++
                )
                  (h = this.chart.axisX[m].dataSeries[b].getDataPointAtX(
                    l,
                    c
                  )) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX[m].dataSeries[b]),
                    null !== h.dataPoint.y && k.push(h));
                h = null;
              }
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++) {
                ...
                for (b = 0; b < this.chart.axisX2[m].dataSeries.length; b++)
                  (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(
                    l,
                    c
                  )) &&
                    0 <= h.index &&
                    ((h.dataSeries = this.chart.axisX2[m].dataSeries[b]),
                    null !== h.dataPoint.y && k.push(h));
                h = null;
              }
          } else {
            ...
            if (this.chart.axisX)
              for (m = 0; m < this.chart.axisX.length; m++)
                for (
                  l = this.chart.axisX[m].convertPixelToValue({ x: a }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX[m].dataSeries.length;
                  b++
            ...
            if (this.chart.axisX2)
              for (m = 0; m < this.chart.axisX2.length; m++)
                for (
                  l = this.chart.axisX2[m].convertPixelToValue({ x: a }),
                    h = null,
                    b = 0;
                  b < this.chart.axisX2[m].dataSeries.length;
                  b++
                )
                  (h = this.chart.axisX2[m].dataSeries[b].getDataPointAtX(
                    l,
          ...
          c = k[0];
          for (b = 0; b < k.length; b++)
            k[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() &&
              f.push(k[b]);
          k = null;
        } else {
          if ((h = this.chart.getDataPointAtXY(a, d, c)))
            ...
            if (
              ((h = Ya(a, d, this.chart._eventManager.ghostCtx)),
              0 < h &&
        ...
        if (0 < f.length) {
          ...
          if (this.enabled) {
            var p = "",
              p = this.getToolTipInnerHTML({ entries: f });
            if (null !== p) {
    ...
    aa.prototype.getToolTipInnerHTML = function (a) {
      a = a.entries;
      for (
        var d = null, c = null, b = null, e = 0, f = "", l = !0, k = 0;
        k < a.length;
        k++
      )
      ...
      if (
        ...
        for (var m = null, h = "", k = 0; k < a.length; k++)
          (c = a[k].dataSeries),
            (b = a[k].dataPoint),
            (e = a[k].index),
            (f = ""),
    ...
    var L = {
      ...
      Y = {
        drawMarker: function (a, d, c, b, e, f, l, k) {
          if (c) {
            var m = 1;
